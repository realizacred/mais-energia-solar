    ...
    extend: {
      colors: {
        ...
        sidebar: {
          ...
          commercial: "hsl(var(--sidebar-section-commercial))",
          operations: "hsl(var(--sidebar-section-operations))",
          finance: "hsl(var(--sidebar-section-finance))",
          admin: "hsl(var(--sidebar-section-admin))",
          /* Legacy aliases for backward compatibility */
          intelligence: "hsl(var(--sidebar-section-intelligence))",
          clients: "hsl(var(--sidebar-section-clients))",
