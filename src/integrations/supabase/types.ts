  ...
  public: {
    Tables: {
      ...
      lead_cliente_links: {
        ...
        Relationships: [
          {
            foreignKeyName: "lead_cliente_links_cliente_id_fkey"
            columns: ["cliente_id"]
            isOneToOne: false
            referencedRelation: "clientes"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "lead_cliente_links_lead_id_fkey"
            columns: ["lead_id"]
            isOneToOne: true
            referencedRelation: "leads"
            referencedColumns: ["id"]
      ...
      plano_servico_features: {
        ...
        Relationships: [
          {
            foreignKeyName: "plano_servico_features_plano_id_fkey"
            columns: ["plano_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "plano_servico_features_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      link_lead_to_cliente: {
        Args: { p_cliente_id: string; p_lead_id: string; p_reason?: string }
        Returns: string
      }
      link_meter_to_unit: {
        Args: {
