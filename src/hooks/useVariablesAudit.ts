...
export const SCHEMA_TABLES: {
  ...
  },
  {
    ...
    columns: [
      { column: "title", label: "Título do Negócio", expectedKey: "deal_titulo" },
  ...
  },
  {
    ...
    columns: [
      ...
      { column: "data_previsao_instalacao", label: "Previsão Instalação", expectedKey: "projeto_data_previsao", colType: "date" },
      ...
      { column: "prazo_estimado_dias", label: "Prazo Estimado (dias)", expectedKey: "projeto_prazo_estimado", colType: "number" },
  ...
  },
  {
    ...
    columns: [
      ...
      { column: "proposta_num", label: "Número da Proposta", expectedKey: "proposta_numero", colType: "number" },
  ...
  },
  {
    ...
    columns: [
      ...
      { column: "inflacao_energetica", label: "Inflação Energética (%)", expectedKey: "inflacao_energetica", colType: "number" },
      { column: "perda_eficiencia_anual", label: "Perda de Eficiência Anual (%)", expectedKey: "perda_eficiencia_anual", colType: "number" },
      { column: "sobredimensionamento", label: "Sobredimensionamento (%)", expectedKey: "sobredimensionamento", colType: "number" },
      { column: "validade_dias", label: "Validade (dias)", expectedKey: "proposta_validade" },
  ...
  },
  {
    ...
    columns: [
      ...
      { column: "payback_meses", label: "Payback (meses)", expectedKey: "payback_meses" },
      { column: "co2_evitado_kg", label: "CO₂ Evitado (kg)", expectedKey: "co2_evitado_kg", colType: "number" },
  ...
  },
  {
    ...
    columns: [
      ...
      { column: "custo_disponibilidade_monofasico", label: "Custo Disp. Monofásico", expectedKey: "concessionaria_custo_disp_mono", colType: "number" },
      { column: "custo_disponibilidade_bifasico", label: "Custo Disp. Bifásico", expectedKey: "concessionaria_custo_disp_bi", colType: "number" },
      { column: "custo_disponibilidade_trifasico", label: "Custo Disp. Trifásico", expectedKey: "concessionaria_custo_disp_tri", colType: "number" },
