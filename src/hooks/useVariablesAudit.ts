...
export const SCHEMA_TABLES: {
  ...
  },
  {
    ...
    columns: [
      ...
      { column: "sigla", label: "Sigla", colType: "string" },
      { column: "estado", label: "Estado", colType: "string" },
      { column: "tarifa_energia", label: "Tarifa Energia", expectedKey: "tarifa_distribuidora" },
      { column: "tarifa_fio_b", label: "Tarifa Fio B", colType: "number" },
      { column: "custo_disponibilidade_monofasico", label: "Custo Disp. Monofásico", colType: "number" },
      { column: "custo_disponibilidade_bifasico", label: "Custo Disp. Bifásico", colType: "number" },
      { column: "custo_disponibilidade_trifasico", label: "Custo Disp. Trifásico", colType: "number" },
      { column: "aliquota_icms", label: "Alíquota ICMS", colType: "number" },
      { column: "possui_isencao_scee", label: "Isenção SCEE", colType: "boolean" },
      { column: "percentual_isencao", label: "% Isenção", colType: "number" },
    ],
  },
];
