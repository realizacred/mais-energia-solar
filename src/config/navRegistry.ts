...
export const NAV_REGISTRY: NavRegistryItem[] = [
  ...
  { nav_key: "pos-venda-upsell", label_default: "Oportunidades", group_default: "Pós-Venda", order_default: 3, icon: "TrendingUp", description: "Vendas adicionais e upgrades", keywords: ["upsell", "bateria", "expansão", "carregador", "oportunidade"], criticality: "normal", permission: "all" },
