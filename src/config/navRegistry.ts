...
export const NAV_REGISTRY: NavRegistryItem[] = [
  ...
  // propostas-nativas integrado dentro de Projetos — rota mantida, menu removido
  { nav_key: "projetos", label_default: "Projetos", group_default: "Comercial", order_default: 3, icon: "FolderKanban", description: "Pipeline de projetos com funil", keywords: ["projeto", "pipeline", "funil", "kanban", "etapa", "proposta"], criticality: "business_critical", permission: "all" },
