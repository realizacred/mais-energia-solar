...
export const NAV_REGISTRY: NavRegistryItem[] = [
  ...
  { nav_key: "propostas", label_default: "Propostas", group_default: "Comercial", order_default: 2, icon: "FileText", description: "Propostas comerciais", keywords: ["orçamento", "cotação", "proposta", "preço"], criticality: "normal", permission: "all" },
  { nav_key: "propostas-nativas", label_default: "Propostas Nativas", group_default: "Comercial", order_default: 3, icon: "FileText", description: "Gerador de propostas solares", keywords: ["proposta", "gerador", "solar", "orçamento", "nativa"], criticality: "business_critical", permission: "all" },
  { nav_key: "propostas-nativas/templates", label_default: "Templates de Proposta", group_default: "Comercial", order_default: 4, icon: "Layout", description: "Modelos de proposta personalizáveis", keywords: ["template", "modelo", "layout", "proposta", "customizar"], criticality: "normal", permission: "admin_only", subsectionLabel: "Propostas" },
  { nav_key: "propostas-nativas/variaveis", label_default: "Variáveis Customizadas", group_default: "Comercial", order_default: 5, icon: "Variable", description: "Campos dinâmicos para propostas", keywords: ["variável", "campo", "dinâmico", "placeholder", "custom"], criticality: "normal", permission: "admin_only" },
  { nav_key: "propostas-nativas/dashboard", label_default: "Dashboard Propostas", group_default: "Comercial", order_default: 6, icon: "BarChart3", description: "Métricas e análises de propostas", keywords: ["dashboard", "métricas", "análise", "proposta", "conversão"], criticality: "normal", permission: "all" },
  { nav_key: "projetos", label_default: "Projetos", group_default: "Comercial", order_default: 7, icon: "FolderKanban", description: "Pipeline de projetos com funil", keywords: ["projeto", "pipeline", "funil", "kanban", "etapa", "proposta"], criticality: "business_critical", permission: "all" },
  { nav_key: "followup", label_default: "Follow-ups", group_default: "Comercial", order_default: 8, icon: "Bell", description: "Acompanhamento de leads", keywords: ["lembrete", "retorno", "agendamento", "tarefa"], criticality: "normal", permission: "all" },
  { nav_key: "distribuicao", label_default: "Distribuição", group_default: "Comercial", order_default: 9, icon: "RotateCcw", description: "Regras & fila de leads", keywords: ["fila", "round-robin", "atribuição", "regras"], criticality: "normal", permission: "admin_only", separator: true },
  { nav_key: "sla-breaches", label_default: "SLA & Breaches", group_default: "Comercial", order_default: 10, icon: "AlertTriangle", description: "Violações de prazo", keywords: ["prazo", "atraso", "violação", "alerta"], criticality: "normal", permission: "admin_only" },
  { nav_key: "inteligencia", label_default: "Inteligência Comercial", group_default: "Comercial", order_default: 11, icon: "Brain", description: "Scoring & Previsão", keywords: ["score", "previsão", "IA", "análise", "ranking"], criticality: "normal", permission: "all", separator: true },
  ...
  { nav_key: "canais-captacao", label_default: "Canais de Captação", group_default: "Administração", order_default: 4, icon: "Megaphone", description: "Fontes de leads e origens", keywords: ["canal", "captação", "origem", "fonte", "lead"], criticality: "normal", permission: "admin_only" },
  { nav_key: "changelog", label_default: "Atualizações", group_default: "Administração", order_default: 5, icon: "History", description: "Histórico de atualizações do sistema", keywords: ["changelog", "atualização", "novidade", "versão", "histórico"], criticality: "normal", permission: "admin_only" },
  { nav_key: "data-reset", label_default: "Limpeza de Dados", group_default: "Administração", order_default: 6, icon: "Trash2", description: "Reset seletivo por segmento", keywords: ["reset", "limpeza", "deletar", "remover"], criticality: "normal", permission: "admin_only" },
];
