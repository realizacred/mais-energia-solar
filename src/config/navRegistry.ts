...
export const NAV_REGISTRY: NavRegistryItem[] = [
  ...
  { nav_key: "instagram", label_default: "Instagram", group_default: "Integrações", order_default: 7, icon: "Instagram", description: "Sincronizar conteúdo do Instagram", keywords: ["instagram", "post", "rede social", "feed"], criticality: "normal", permission: "admin_only" },
  ...
  { nav_key: "custom-fields", label_default: "Opções Customizáveis", group_default: "Projetos & Propostas", order_default: 0, icon: "Settings2", description: "Campos customizados, premissas, tipos de atividade e motivos de perda", keywords: ["campo", "customizado", "atividade", "motivo", "perda", "funil", "personalizar", "custom", "premissa"], criticality: "normal", permission: "admin_only" },
  { nav_key: "ai-config", label_default: "Configuração de IA", group_default: "Projetos & Propostas", order_default: 1, icon: "Brain", description: "Modelo, temperatura e regras de IA", keywords: ["ia", "ai", "openai", "gpt", "modelo", "inteligência", "artificial", "configuração"], criticality: "normal", permission: "admin_only" },
