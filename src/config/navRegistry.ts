...
export const NAV_REGISTRY: NavRegistryItem[] = [
  ...
  // ── Integrações ──
  { nav_key: "integracoes-status", label_default: "Painel de Integrações", group_default: "Integrações", order_default: 0, icon: "Activity", description: "Status e saúde das conexões ativas", keywords: ["status", "health", "integração", "API", "monitoramento"], criticality: "normal", permission: "admin_only" },
  { nav_key: "wa-instances", label_default: "Instâncias WhatsApp", group_default: "Integrações", order_default: 1, icon: "Smartphone", description: "Gerenciar números e conexões WhatsApp", keywords: ["instância", "evolution", "API", "número"], criticality: "normal", permission: "admin_only" },
  { nav_key: "whatsapp", label_default: "WhatsApp API", group_default: "Integrações", order_default: 2, icon: "MessageCircle", description: "Automações e configurações de mensagens", keywords: ["API", "automação", "webhook", "bot"], criticality: "normal", permission: "admin_only" },
  { nav_key: "instagram", label_default: "Instagram", group_default: "Integrações", order_default: 3, icon: "Instagram", description: "Sincronizar conteúdo do Instagram", keywords: ["instagram", "post", "rede social", "feed"], criticality: "normal", permission: "admin_only" },
  
  { nav_key: "webhooks", label_default: "Webhooks", group_default: "Integrações", order_default: 5, icon: "Webhook", description: "Conexões com sistemas externos", keywords: ["webhook", "integração", "API", "n8n"], criticality: "normal", permission: "admin_only" },
  { nav_key: "n8n", label_default: "Automações", group_default: "Integrações", order_default: 6, icon: "Workflow", description: "Workflows e processos automatizados", keywords: ["n8n", "automação", "workflow", "MCP"], criticality: "normal", permission: "admin_only" },
  // google-calendar route exists but menu item removed (unified into agenda-config)
  { nav_key: "ai-config", label_default: "Configuração de IA", group_default: "Integrações", order_default: 8, icon: "Brain", description: "Modelo, temperatura e regras de IA", keywords: ["ia", "ai", "openai", "gpt", "modelo", "inteligência", "artificial", "configuração"], criticality: "normal", permission: "admin_only" },

  // ── Site ──
  { nav_key: "site-config", label_default: "Conteúdo & Visual", group_default: "Site", order_default: 0, icon: "Globe", description: "Personalizar layout e textos do site", keywords: ["site", "landing", "visual", "layout", "marca"], criticality: "normal", permission: "admin_only" },
  { nav_key: "site-servicos", label_default: "Serviços", group_default: "Site", order_default: 1, icon: "Wrench", description: "Serviços exibidos no site", keywords: ["serviço", "oferta", "landing"], criticality: "normal", permission: "admin_only" },
  { nav_key: "obras", label_default: "Portfólio", group_default: "Site", order_default: 2, icon: "Sun", description: "Projetos realizados e fotos", keywords: ["portfólio", "obra", "projeto", "foto"], criticality: "normal", permission: "admin_only" },

  // ── Configurações ──
  { nav_key: "conf-solar", label_default: "Premissas Solar", group_default: "Configurações", order_default: -1, icon: "Sun", description: "Premissas técnicas, preços e margens", keywords: ["premissa", "preço", "markup", "financiamento", "solar", "configuração"], criticality: "business_critical", permission: "admin_only" },
  { nav_key: "config", label_default: "Calculadora Solar", group_default: "Configurações", order_default: 0, icon: "Calculator", description: "Parâmetros de geração e custo por kWp", keywords: ["cálculo", "geração", "kWp", "tarifa", "custo"], criticality: "normal", permission: "admin_only" },
  { nav_key: "lead-status", label_default: "Etapas do Funil", group_default: "Configurações", order_default: 1, icon: "Kanban", description: "Personalizar etapas e status de leads", keywords: ["etapa", "funil", "personalizar", "status"], criticality: "normal", permission: "admin_only" },
  { nav_key: "motivos-perda", label_default: "Motivos de Perda", group_default: "Configurações", order_default: 2, icon: "XCircle", description: "Catalogar razões de perda de negócios", keywords: ["perda", "motivo", "relatório", "análise"], criticality: "normal", permission: "admin_only" },
  { nav_key: "respostas-rapidas", label_default: "Respostas Rápidas", group_default: "Configurações", order_default: 3, icon: "Sparkles", description: "Templates de mensagens pré-definidas", keywords: ["template", "atalho", "mensagem", "rápida"], criticality: "normal", permission: "admin_only" },
  { nav_key: "wa-etiquetas", label_default: "Etiquetas WhatsApp", group_default: "Configurações", order_default: 4, icon: "Tag", description: "Tags para organizar conversas", keywords: ["tag", "etiqueta", "classificação", "organizar"], criticality: "normal", permission: "admin_only" },
  { nav_key: "equipamentos", label_default: "Disjuntores & Transf.", group_default: "Configurações", order_default: 5, icon: "Plug", description: "Cadastro de equipamentos elétricos", keywords: ["disjuntor", "transformador", "proteção", "elétrico"], criticality: "normal", permission: "admin_only", separator: true },
  { nav_key: "modulos", label_default: "Módulos Fotovoltaicos", group_default: "Configurações", order_default: 6, icon: "SunMedium", description: "Painéis solares disponíveis para projeto", keywords: ["painel", "módulo", "solar", "fotovoltaico", "placa"], criticality: "normal", permission: "admin_only" },
  { nav_key: "inversores-cadastro", label_default: "Inversores", group_default: "Configurações", order_default: 7, icon: "Cpu", description: "Inversores cadastrados para dimensionamento", keywords: ["inversor", "potência", "micro-inversor", "string"], criticality: "normal", permission: "admin_only" },
  { nav_key: "baterias", label_default: "Baterias", group_default: "Configurações", order_default: 8, icon: "Battery", description: "Sistemas de armazenamento de energia", keywords: ["bateria", "armazenamento", "lítio", "energia"], criticality: "normal", permission: "admin_only" },
  { nav_key: "concessionarias", label_default: "Concessionárias", group_default: "Configurações", order_default: 9, icon: "Lightbulb", description: "Tarifas e dados das distribuidoras", keywords: ["tarifa", "distribuidora", "concessionária", "ANEEL"], criticality: "normal", permission: "admin_only" },
  { nav_key: "menus", label_default: "Personalizar Menu", group_default: "Configurações", order_default: 10, icon: "LayoutList", description: "Organizar e renomear itens do menu", keywords: ["menu", "navegação", "sidebar", "personalizar", "ordem"], criticality: "normal", permission: "admin_only" },
  { nav_key: "agenda-config", label_default: "Agenda & Calendário", group_default: "Configurações", order_default: 11, icon: "Calendar", description: "Agenda interna e sincronização Google Calendar", keywords: ["agenda", "compromisso", "google", "calendar", "agendamento"], criticality: "normal", permission: "admin_only", separator: true },
  { nav_key: "loading-config", label_default: "Personalização Visual", group_default: "Configurações", order_default: 12, icon: "Loader2", description: "Animação de carregamento e mensagens", keywords: ["loading", "mensagem", "animação", "sol", "overlay"], criticality: "normal", permission: "admin_only" },

  // ── Administração ──
  { nav_key: "tenant-settings", label_default: "Dados da Empresa", group_default: "Administração", order_default: -1, icon: "Building2", description: "Identidade, localização e configurações gerais", keywords: ["empresa", "cnpj", "tenant", "configuração", "crm", "cadastro"], criticality: "normal", permission: "admin_only" },
  { nav_key: "usuarios", label_default: "Usuários & Permissões", group_default: "Administração", order_default: 0, icon: "Shield", description: "Controle de acessos e papéis", keywords: ["usuário", "permissão", "role", "acesso"], criticality: "system_critical", permission: "admin_only" },
  { nav_key: "auditoria", label_default: "Registro de Atividades", group_default: "Administração", order_default: 1, icon: "FileSearch", description: "Histórico completo de alterações no sistema", keywords: ["log", "auditoria", "histórico", "alteração"], criticality: "normal", permission: "admin_only" },
  { nav_key: "notificacoes-config", label_default: "Notificações", group_default: "Administração", order_default: 2, icon: "Bell", description: "Configurar alertas e notificações da empresa", keywords: ["notificação", "push", "alerta", "configurar", "ativar"], criticality: "normal", permission: "admin_only", separator: true },
  { nav_key: "links-instalacao", label_default: "Captação & App", group_default: "Administração", order_default: 3, icon: "Smartphone", description: "Links de captação, QR Codes e instalação PWA", keywords: ["PWA", "link", "instalação", "app", "canal", "captação", "qr", "code", "whatsapp"], criticality: "normal", permission: "admin_only" },
  { nav_key: "canais-captacao", label_default: "Canais de Captação", group_default: "Administração", order_default: 4, icon: "Megaphone", description: "Fontes e origens dos seus leads", keywords: ["canal", "captação", "origem", "fonte", "lead"], criticality: "normal", permission: "admin_only" },
  { nav_key: "changelog", label_default: "Atualizações do Sistema", group_default: "Administração", order_default: 5, icon: "History", description: "Novidades e melhorias recentes", keywords: ["changelog", "atualização", "novidade", "versão", "histórico"], criticality: "normal", permission: "admin_only" },
  { nav_key: "data-reset", label_default: "Manutenção de Dados", group_default: "Administração", order_default: 6, icon: "Trash2", description: "Limpeza seletiva e reset de dados", keywords: ["reset", "limpeza", "deletar", "remover", "manutenção"], criticality: "normal", permission: "admin_only" },
];
