...
export const NAV_REGISTRY: NavRegistryItem[] = [
  ...
  { nav_key: "propostas-nativas", label_default: "Propostas", group_default: "Comercial", order_default: 1, icon: "FileText", description: "Geração, envio e acompanhamento de propostas comerciais", keywords: ["proposta", "orçamento", "documento", "wizard", "gerador", "envio", "PDF"], criticality: "business_critical", permission: "all" },
  { nav_key: "pipeline", label_default: "Funil Comercial", group_default: "Comercial", order_default: 2, icon: "Kanban", description: "Visualize e gerencie as etapas de venda", keywords: ["kanban", "etapas", "funil", "conversão", "pipeline"], criticality: "normal", permission: "all" },
  ...
  { nav_key: "irradiancia", label_default: "Base Meteorológica", group_default: "Cadastros", order_default: 7, icon: "Sun", description: "Datasets de irradiância, versões, importação CSV e auditoria", keywords: ["irradiância", "solar", "dataset", "INPE", "NASA", "importação", "GHI", "DHI", "DNI", "CSV", "meteorológica", "atlas", "limpar"], criticality: "normal", permission: "admin_only" },
  { nav_key: "base-meteorologica", label_default: "Providers & Versionamento", group_default: "Cadastros", order_default: 8, icon: "Database", description: "Gerenciamento de providers de irradiância (INPE, NASA), importação por API/CSV e versionamento", keywords: ["provider", "meteorológica", "versionamento", "INPE", "NASA", "API", "importar", "sincronizar", "purge", "limpar"], criticality: "normal", permission: "admin_only" },
  ...
  { nav_key: "saude-integracoes", label_default: "Saúde das integrações", group_default: "Configurações", order_default: 19, icon: "Activity", description: "Status em tempo real de todas as conexões externas", keywords: ["saúde", "health", "status", "integração", "monitoramento", "conexão"], criticality: "normal", permission: "admin_only", subsectionLabel: "Integrações" },
  { nav_key: "integracoes", label_default: "Google Agenda", group_default: "Configurações", order_default: 20, icon: "Calendar", description: "Configurar, auditar e gerenciar integração com Google Agenda", keywords: ["integração", "google", "calendar", "agenda", "oauth", "auditoria"], criticality: "normal", permission: "admin_only" },
  { nav_key: "openai-config", label_default: "OpenAI", group_default: "Configurações", order_default: 20.1, icon: "Bot", description: "Configurar chave de API do OpenAI", keywords: ["openai", "gpt", "api", "key", "ia"], criticality: "normal", permission: "admin_only" },
  { nav_key: "gemini-config", label_default: "Google Gemini", group_default: "Configurações", order_default: 20.2, icon: "Sparkles", description: "Configurar chave de API do Google Gemini", keywords: ["gemini", "google", "ai", "api", "key"], criticality: "normal", permission: "admin_only" },
  { nav_key: "solarmarket-config", label_default: "SolarMarket", group_default: "Configurações", order_default: 20.3, icon: "Sun", description: "Configurar chave de API do SolarMarket", keywords: ["solarmarket", "cotação", "equipamento", "preço"], criticality: "normal", permission: "admin_only" },
