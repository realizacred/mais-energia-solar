...
export const NAV_REGISTRY: NavRegistryItem[] = [
  ...
  { nav_key: "modulos-auditoria", label_default: "Auditoria de Módulos", group_default: "Cadastros", order_default: 1.5, icon: "ShieldCheck", description: "Audita catálogo de módulos: garantias, datasheets, duplicados", keywords: ["auditoria", "módulo", "painel", "datasheet", "garantia"], criticality: "normal", permission: "admin_only" },
  ...
  { nav_key: "inversores-auditoria", label_default: "Auditoria de Inversores", group_default: "Cadastros", order_default: 2.5, icon: "ShieldCheck", description: "Audita catálogo de inversores: garantias, datasheets, duplicados", keywords: ["auditoria", "inversor", "datasheet", "garantia", "duplicado", "limpeza"], criticality: "normal", permission: "admin_only" },
  ...
  { nav_key: "baterias-auditoria", label_default: "Auditoria de Baterias", group_default: "Cadastros", order_default: 3.2, icon: "ShieldCheck", description: "Audita catálogo de baterias: garantias, datasheets", keywords: ["auditoria", "bateria", "datasheet", "garantia"], criticality: "normal", permission: "admin_only" },
  ...
  { nav_key: "otimizadores-auditoria", label_default: "Auditoria de Otimizadores", group_default: "Cadastros", order_default: 3.7, icon: "ShieldCheck", description: "Audita catálogo de otimizadores: garantias, datasheets", keywords: ["auditoria", "otimizador", "datasheet", "garantia"], criticality: "normal", permission: "admin_only" },
  ...
  { nav_key: "automacoes", label_default: "Automações", group_default: "Comercial", order_default: 11, icon: "Zap", description: "Regras automáticas de pipeline, WhatsApp e webhooks", keywords: ["automação", "pipeline", "whatsapp", "webhook", "regra", "gatilho"], criticality: "normal", permission: "admin_only" },
