...
export const NAV_REGISTRY: NavRegistryItem[] = [
  ...
  { nav_key: "projetos", label_default: "Projetos", group_default: "Comercial", order_default: 4, icon: "FolderKanban", description: "Pipeline de projetos com funil", keywords: ["projeto", "pipeline", "funil", "kanban", "etapa"], criticality: "business_critical", permission: "all" },
