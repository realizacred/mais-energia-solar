...
export const NAV_REGISTRY: NavRegistryItem[] = [
  ...
  { nav_key: "integracoes/visao-geral", label_default: "Visão Geral", group_default: "Integrações", order_default: 2, icon: "LayoutGrid", description: "Status consolidado de WhatsApp, SolarMarket, IA e Conexões", keywords: ["visão", "geral", "overview", "status", "integração"], criticality: "normal", permission: "admin_only", subsectionLabel: "WhatsApp" },
  { nav_key: "integracoes/whatsapp/saude", label_default: "Saúde", group_default: "Integrações", order_default: 3, icon: "Activity", description: "Status e diagnóstico das instâncias WhatsApp", keywords: ["whatsapp", "saúde", "health", "status", "instância"], criticality: "normal", permission: "admin_only" },
  ...
  { nav_key: "integracoes/whatsapp/follow-up", label_default: "Follow-up", group_default: "Integrações", order_default: 7, icon: "Clock", description: "Cadências e follow-up automático", keywords: ["whatsapp", "follow", "up", "cadência"], criticality: "normal", permission: "admin_only", subsectionLabel: "SolarMarket" },
  { nav_key: "integracoes/solarmarket/migracao", label_default: "Migração", group_default: "Integrações", order_default: 8, icon: "Cloud", description: "Wizard de migração de dados SolarMarket", keywords: ["solarmarket", "migração", "importação"], criticality: "normal", permission: "admin_only" },
  ...
  { nav_key: "integracoes/solarmarket/consultores", label_default: "Mapeamento de Consultores", group_default: "Integrações", order_default: 12, icon: "Users", description: "Mapear consultores SolarMarket → consultores nativos", keywords: ["solarmarket", "consultor", "vendedor", "mapeamento"], criticality: "normal", permission: "admin_only", subsectionLabel: "IA" },
  { nav_key: "integracoes/ia/provedores", label_default: "Provedores", group_default: "Integrações", order_default: 13, icon: "Brain", description: "Provedor e modelo de IA ativo", keywords: ["ia", "provedor", "openai", "gemini", "modelo"], criticality: "normal", permission: "admin_only" },
  { nav_key: "integracoes/ia/features", label_default: "Features", group_default: "Integrações", order_default: 14, icon: "Sparkles", description: "Ativar/desativar features de IA por área", keywords: ["ia", "feature", "ativar", "desativar"], criticality: "normal", permission: "admin_only" },
  { nav_key: "integracoes/ia/lead-scoring", label_default: "Lead Scoring", group_default: "Integrações", order_default: 15, icon: "TrendingUp", description: "Configuração do score de leads por IA", keywords: ["ia", "lead", "scoring", "pontuação"], criticality: "normal", permission: "admin_only", subsectionLabel: "Conexões" },
  { nav_key: "integracoes/conexoes/provedores", label_default: "Provedores", group_default: "Integrações", order_default: 16, icon: "Plug", description: "Catálogo de provedores de integração", keywords: ["conexão", "provedor", "catálogo"], criticality: "normal", permission: "admin_only" },
  { nav_key: "integracoes/conexoes/credenciais", label_default: "Credenciais", group_default: "Integrações", order_default: 17, icon: "Key", description: "Credenciais armazenadas das integrações", keywords: ["credencial", "chave", "api", "token"], criticality: "normal", permission: "admin_only" },
  { nav_key: "integracoes/conexoes/jobs", label_default: "Jobs", group_default: "Integrações", order_default: 18, icon: "Workflow", description: "Jobs de sincronização e saúde", keywords: ["job", "sincronização", "fila", "worker"], criticality: "normal", permission: "admin_only" },
  { nav_key: "integracoes/conexoes/logs", label_default: "Logs", group_default: "Integrações", order_default: 19, icon: "FileSearch", description: "Auditoria e logs operacionais", keywords: ["log", "auditoria", "histórico"], criticality: "normal", permission: "admin_only" },
