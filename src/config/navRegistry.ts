...
export const NAV_REGISTRY: NavRegistryItem[] = [
  ...
  { nav_key: "inteligencia", label_default: "Inteligência Comercial", group_default: "Comercial", order_default: 7, icon: "Brain", description: "Scoring de leads e previsão de receita", keywords: ["score", "previsão", "IA", "análise", "ranking"], criticality: "normal", permission: "all", separator: true },
  ...
  { nav_key: "wa-instances", label_default: "Instâncias WhatsApp", group_default: "Integrações", order_default: 4, icon: "Smartphone", description: "Conexões Evolution API (QR Code)", keywords: ["instância", "evolution", "API", "número", "QR"], criticality: "normal", permission: "admin_only", separator: true },
  { nav_key: "whatsapp", label_default: "Automação WhatsApp", group_default: "Integrações", order_default: 5, icon: "Bot", description: "Respostas automáticas, boas-vindas e horário comercial", keywords: ["API", "automação", "webhook", "bot", "auto-resposta"], criticality: "normal", permission: "admin_only" },
  ...
  { nav_key: "solarmarket", label_default: "SolarMarket Importação", group_default: "Energia", order_default: 5, icon: "Sun", description: "Importar clientes, projetos e propostas do SolarMarket", keywords: ["solarmarket", "importar", "cliente", "projeto", "proposta", "sincronizar"], criticality: "normal", permission: "admin_only", separator: true },
  ...
  { nav_key: "meta-dashboard", label_default: "Meta Ads Dashboard", group_default: "Integrações", order_default: 2, icon: "BarChart3", description: "Métricas de campanhas Meta/Facebook Ads", keywords: ["meta", "facebook", "ads", "campanha", "anúncio", "marketing"], criticality: "normal", permission: "admin_only" },
  { nav_key: "webhooks", label_default: "Webhooks", group_default: "Integrações", order_default: 3, icon: "Webhook", description: "Integrações externas via webhooks", keywords: ["webhook", "integração", "API", "n8n"], criticality: "normal", permission: "admin_only", separator: true },
  { nav_key: "monitoramento/integracoes", label_default: "Integrações Monitoramento", group_default: "Integrações", order_default: 6, icon: "Plug", description: "Configuração de provedores de monitoramento", keywords: ["provider", "solarman", "solaredge", "solis", "deye", "integração"], criticality: "normal", permission: "admin_only", separator: true },
  { nav_key: "solarmarket-config", label_default: "SolarMarket Config", group_default: "Integrações", order_default: 7, icon: "Sun", description: "API Key para cotações de equipamentos", keywords: ["solarmarket", "cotação", "api", "key"], criticality: "normal", permission: "admin_only" },
  { nav_key: "medidores", label_default: "Medidores", group_default: "Integrações", order_default: 8, icon: "Gauge", description: "Dispositivos de medição IoT sincronizados via API", keywords: ["medidor", "meter", "tuya", "IoT", "smart meter"], criticality: "normal", permission: "admin_only" },
  { nav_key: "google-maps-config", label_default: "Google Maps", group_default: "Integrações", order_default: 9, icon: "MapPin", description: "API Key para mapas e geocodificação", keywords: ["google", "maps", "mapa", "api", "geocodificação"], criticality: "normal", permission: "admin_only" },
  { nav_key: "instagram", label_default: "Instagram", group_default: "Integrações", order_default: 10, icon: "Instagram", description: "Conexão e sincronização do feed Instagram", keywords: ["instagram", "post", "rede social", "feed", "API"], criticality: "normal", permission: "admin_only" },
...
export const NAV_SECTION_DEFAULTS: NavSectionMeta[] = [
  ...
  { label: "Equipe",           icon: "Users",          order: 7,   indicatorBg: "bg-sidebar-team",          activeClass: ACTIVE("team"),          hoverClass: HOVER("team"),          labelClass: LABEL("team"),          defaultOpen: false },
  ...
  { label: "Energia",          icon: "Zap",            order: 9,   indicatorBg: "bg-sidebar-energy",        activeClass: ACTIVE("energy"),        hoverClass: HOVER("energy"),        labelClass: LABEL("energy"),        defaultOpen: false },
