...
export const NAV_REGISTRY: NavRegistryItem[] = [
  ...
  { nav_key: "propostas", label_default: "Propostas", group_default: "Comercial", order_default: 2, icon: "FileText", description: "Propostas comerciais", keywords: ["orçamento", "cotação", "simulação", "preço"], criticality: "normal", permission: "all" },
  ...
  { nav_key: "distribuicao", label_default: "Distribuição", group_default: "Comercial", order_default: 4, icon: "RotateCcw", description: "Regras & fila de leads", keywords: ["fila", "round-robin", "atribuição", "regras"], criticality: "normal", permission: "admin_only", separator: true },
  { nav_key: "sla-breaches", label_default: "SLA & Breaches", group_default: "Comercial", order_default: 5, icon: "AlertTriangle", description: "Violações de prazo", keywords: ["prazo", "atraso", "violação", "alerta"], criticality: "normal", permission: "admin_only" },
  { nav_key: "inteligencia", label_default: "Inteligência Comercial", group_default: "Comercial", order_default: 6, icon: "Brain", description: "Scoring & Previsão", keywords: ["score", "previsão", "IA", "análise", "ranking"], criticality: "normal", permission: "all", separator: true },
  ...
  { nav_key: "loading-config", label_default: "Loading & Mensagens", group_default: "Configurações", order_default: 11, icon: "Loader2", description: "Animação de loading e mensagens", keywords: ["loading", "mensagem", "animação", "sol", "overlay"], criticality: "normal", permission: "admin_only" },
  ...
  { nav_key: "links-instalacao", label_default: "Links & Instalação", group_default: "Administração", order_default: 3, icon: "Smartphone", description: "App PWA e links de consultor", keywords: ["PWA", "link", "instalação", "app"], criticality: "normal", permission: "admin_only" },
