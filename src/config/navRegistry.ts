...
export const NAV_REGISTRY: NavRegistryItem[] = [
  ...
  { nav_key: "irradiance-import", label_default: "Importar Atlas (3 CSV)", group_default: "Cadastros", order_default: 8, icon: "Upload", description: "Importar GHI, DHI e DNI do Atlas Brasileiro via CSV", keywords: ["importar", "atlas", "CSV", "GHI", "DHI", "DNI", "INPE", "CEPEL"], criticality: "normal", permission: "admin_only" },
