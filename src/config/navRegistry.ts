...
export const NAV_REGISTRY: NavRegistryItem[] = [
  ...
  { nav_key: "monitoramento/integracoes", label_default: "Integrações Monitoramento", group_default: "Energia", order_default: 6, icon: "Plug", description: "Configuração de provedores de monitoramento", keywords: ["provider", "solarman", "solaredge", "solis", "deye", "integração"], criticality: "normal", permission: "admin_only" },
  { nav_key: "solarmarket-config", label_default: "SolarMarket Config", group_default: "Energia", order_default: 7, icon: "Sun", description: "API Key para cotações de equipamentos", keywords: ["solarmarket", "cotação", "api", "key"], criticality: "normal", permission: "admin_only", separator: true },
  { nav_key: "solarmarket", label_default: "SolarMarket Importação", group_default: "Energia", order_default: 8, icon: "Sun", description: "Importar clientes, projetos e propostas do SolarMarket", keywords: ["solarmarket", "importar", "cliente", "projeto", "proposta", "sincronizar"], criticality: "normal", permission: "admin_only" },
