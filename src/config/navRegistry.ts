...
export const NAV_REGISTRY: NavRegistryItem[] = [
  ...
  { nav_key: "insumos-irradiacao", label_default: "Insumos de Irradiação", group_default: "Cadastros", order_default: 8, icon: "Gauge", description: "Dashboard de captura de HSP, coordenadas e variáveis ambientais para auditoria", keywords: ["irradiação", "HSP", "albedo", "sujidade", "auditoria", "insumos", "coordenadas", "temperatura"], criticality: "normal", permission: "admin_only" },
  { nav_key: "base-meteorologica", label_default: "Providers & Versionamento", group_default: "Cadastros", order_default: 9, icon: "Database", description: "Gerenciamento de providers de irradiância (INPE, NASA), importação por API/CSV e versionamento", keywords: ["provider", "meteorológica", "versionamento", "INPE", "NASA", "API", "importar", "sincronizar", "purge", "limpar"], criticality: "normal", permission: "admin_only" },
