...
export const NAV_REGISTRY: NavRegistryItem[] = [
  ...
  { nav_key: "pricing-policy", label_default: "Política de Preços", group_default: "Financeiro", order_default: 5, icon: "Shield", description: "Regras versionadas de precificação, margens e comissões", keywords: ["precificação", "margem", "comissão", "custo", "política", "pricing"], criticality: "business_critical", permission: "admin_only" },
