...
export const NAV_REGISTRY: NavRegistryItem[] = [
  ...
  // ── Meta (Marketing / Facebook Ads — Product UI) ──
  ...
  { nav_key: "meta-config", label_default: "Configuração", group_default: "Meta", order_default: 3, icon: "Settings", description: "Credenciais e conexão com Meta (redireciona para Integrações)", keywords: ["meta", "config", "token", "credencial"], criticality: "normal", permission: "admin_only" },
  ...
  { nav_key: "monitoramento-solar", label_default: "Providers", group_default: "Monitoramento", order_default: 4, icon: "Plug", description: "Configuração de provedores de monitoramento", keywords: ["provider", "solarman", "solaredge", "solis", "deye", "integração"], criticality: "normal", permission: "admin_only" },

  // ── Integrações ──
  { nav_key: "catalogo-integracoes", label_default: "Todas as Integrações", group_default: "Integrações", order_default: -1, icon: "Plug", description: "Catálogo completo de integrações disponíveis", keywords: ["integração", "catálogo", "provider", "conectar", "solar", "crm", "pagamento", "webhook"], criticality: "normal", permission: "admin_only" },
  ...
  { nav_key: "meta-facebook-config", label_default: "Meta (Facebook Ads)", group_default: "Integrações", order_default: 6, icon: "Facebook", description: "Credenciais e webhook do Meta para captura de leads e métricas", keywords: ["meta", "facebook", "ads", "token", "webhook", "credencial"], criticality: "normal", permission: "admin_only" },
  { nav_key: "wa-instances", label_default: "Instâncias WhatsApp", group_default: "Integrações", order_default: 7, icon: "Smartphone", description: "Gerenciar números e conexões WhatsApp", keywords: ["instância", "evolution", "API", "número"], criticality: "normal", permission: "admin_only" },
  { nav_key: "whatsapp", label_default: "WhatsApp API", group_default: "Integrações", order_default: 8, icon: "MessageCircle", description: "Automações e configurações de mensagens", keywords: ["API", "automação", "webhook", "bot"], criticality: "normal", permission: "admin_only" },
  { nav_key: "instagram", label_default: "Instagram", group_default: "Integrações", order_default: 9, icon: "Instagram", description: "Sincronizar conteúdo do Instagram", keywords: ["instagram", "post", "rede social", "feed"], criticality: "normal", permission: "admin_only" },
  { nav_key: "webhooks", label_default: "Webhooks", group_default: "Integrações", order_default: 10, icon: "Webhook", description: "Conexões com sistemas externos", keywords: ["webhook", "integração", "API", "n8n"], criticality: "normal", permission: "admin_only" },
  { nav_key: "n8n", label_default: "Automações", group_default: "Integrações", order_default: 11, icon: "Workflow", description: "Workflows e processos automatizados", keywords: ["n8n", "automação", "workflow", "MCP"], criticality: "normal", permission: "admin_only" },
  { nav_key: "payment-gateway", label_default: "Pagamentos (Asaas)", group_default: "Integrações", order_default: 12, icon: "CreditCard", description: "Configurar gateway de pagamento para boletos e Pix", keywords: ["asaas", "boleto", "pix", "pagamento", "gateway", "cobrança"], criticality: "normal", permission: "admin_only" },
...
export const NAV_SECTION_DEFAULTS: NavSectionMeta[] = [
  ...
  { label: "Meta", icon: "Facebook", order: 9.5, indicatorBg: "bg-sidebar-marketing", activeClass: "bg-sidebar-marketing/12 text-sidebar-marketing font-semibold border-l-2 border-sidebar-marketing", hoverClass: "hover:bg-sidebar-marketing/6", labelClass: "text-sidebar-marketing", defaultOpen: false },
  { label: "Site", icon: "Globe", order: 10, indicatorBg: "bg-sidebar-marketing", activeClass: "bg-sidebar-marketing/12 text-sidebar-marketing font-semibold border-l-2 border-sidebar-marketing", hoverClass: "hover:bg-sidebar-marketing/6", labelClass: "text-sidebar-marketing", defaultOpen: false },
  { label: "Monitoramento", icon: "Sun", order: 10.5, indicatorBg: "bg-sidebar-commercial", activeClass: "bg-sidebar-commercial/12 text-sidebar-commercial font-semibold border-l-2 border-sidebar-commercial", hoverClass: "hover:bg-sidebar-commercial/6", labelClass: "text-sidebar-commercial", defaultOpen: false },
  { label: "Integrações", icon: "Plug", order: 11, indicatorBg: "bg-sidebar-settings", activeClass: "bg-sidebar-settings/12 text-sidebar-settings font-semibold border-l-2 border-sidebar-settings", hoverClass: "hover:bg-sidebar-settings/6", labelClass: "text-sidebar-settings", defaultOpen: false },
