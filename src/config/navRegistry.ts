...
export const NAV_REGISTRY: NavRegistryItem[] = [
  ...
  { nav_key: "projetos", label_default: "Projetos", group_default: "Comercial", order_default: 2, icon: "FolderKanban", description: "Pipeline de projetos com funil e propostas", keywords: ["projeto", "pipeline", "funil", "kanban", "etapa", "proposta", "gerador"], criticality: "business_critical", permission: "all" },
  { nav_key: "followup", label_default: "Follow-ups", group_default: "Comercial", order_default: 3, icon: "Bell", description: "Acompanhamento de leads", keywords: ["lembrete", "retorno", "agendamento", "tarefa"], criticality: "normal", permission: "all" },
