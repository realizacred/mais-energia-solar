...
export const NAV_REGISTRY: NavRegistryItem[] = [
  ...
  { nav_key: "custom-fields", label_default: "Opções Customizáveis", group_default: "Configurações", order_default: 44.5, icon: "Settings2", description: "Campos customizados, tipos de atividade e motivos de perda do CRM", keywords: ["campo", "customizado", "atividade", "motivo", "perda", "funil", "personalizar", "custom"], criticality: "normal", permission: "admin_only" },
