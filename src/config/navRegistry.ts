...
export const NAV_REGISTRY: NavRegistryItem[] = [
  ...
  { nav_key: "canais-captacao", label_default: "Canais de Captação", group_default: "Gestão", order_default: 1, icon: "QrCode", description: "Links e QR Codes por consultor", keywords: ["canal", "captação", "link", "qr", "code", "indicação"], criticality: "normal", permission: "admin_only" },
