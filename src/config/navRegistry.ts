...
export const NAV_REGISTRY: NavRegistryItem[] = [
  ...
  { nav_key: "custom-fields", label_default: "Opções Customizáveis", group_default: "Configurações", order_default: 43.5, icon: "Settings2", description: "Campos customizados, premissas, tipos de atividade e motivos de perda", keywords: ["campo", "customizado", "atividade", "motivo", "perda", "funil", "personalizar", "custom", "premissa"], criticality: "normal", permission: "admin_only" },
