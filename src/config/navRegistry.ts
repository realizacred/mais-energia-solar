...
export const NAV_REGISTRY: NavRegistryItem[] = [
  ...
  { nav_key: "canais-captacao", label_default: "Canais de Captação", group_default: "Configurações", order_default: 45, icon: "Megaphone", description: "Fontes e origens dos seus leads", keywords: ["canal", "captação", "origem", "fonte", "lead"], criticality: "normal", permission: "admin_only" },
...
export const NAV_SECTION_DEFAULTS: NavSectionMeta[] = [
  ...
  { label: "Site", icon: "Globe", order: 8, indicatorBg: "bg-sidebar-marketing", activeClass: "bg-sidebar-marketing/12 text-sidebar-marketing font-semibold border-l-2 border-sidebar-marketing", hoverClass: "hover:bg-sidebar-marketing/6", labelClass: "text-sidebar-marketing", defaultOpen: false },
  { label: "Configurações", icon: "Settings", order: 9, indicatorBg: "bg-sidebar-settings", activeClass: "bg-sidebar-settings/12 text-sidebar-settings font-semibold border-l-2 border-sidebar-settings", hoverClass: "hover:bg-sidebar-settings/6", labelClass: "text-sidebar-settings", defaultOpen: false },
];
