...
export const NAV_REGISTRY: NavRegistryItem[] = [
  ...
  { nav_key: "solarmarket", label_default: "SolarMarket Importação", group_default: "Energia", order_default: 6, icon: "Sun", description: "Importar clientes, projetos e propostas do SolarMarket", keywords: ["solarmarket", "importar", "cliente", "projeto", "proposta", "sincronizar"], criticality: "normal", permission: "admin_only", separator: true },
