...
export const NAV_REGISTRY: NavRegistryItem[] = [
  ...
  { nav_key: "irradiancia", label_default: "Dados Solares", group_default: "Cadastros", order_default: 7, icon: "Sun", description: "Datasets de irradiância, versões e importação", keywords: ["irradiância", "solar", "dataset", "INPE", "NASA", "importação", "GHI"], criticality: "normal", permission: "admin_only" },
  { nav_key: "irradiance-import", label_default: "Base Meteorológica", group_default: "Cadastros", order_default: 8, icon: "Upload", description: "Auditoria, limpeza e importação de irradiância via CSV", keywords: ["importar", "atlas", "CSV", "GHI", "DHI", "DNI", "INPE", "CEPEL", "meteorológica", "limpar"], criticality: "normal", permission: "admin_only" },
