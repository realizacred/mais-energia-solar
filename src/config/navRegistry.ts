...
export const NAV_REGISTRY: NavRegistryItem[] = [
  ...
  { nav_key: "solarmarket-config", label_default: "SolarMarket Configuração", group_default: "Integrações", order_default: 3, icon: "Settings2", description: "Configure API key, campos personalizados e mapeamento de consultores do SolarMarket", keywords: ["solarmarket", "configurar", "api", "key", "campos", "consultores", "mapeamento", "vendedor"], criticality: "normal", permission: "admin_only" },
