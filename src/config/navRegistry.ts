...
export const NAV_REGISTRY: NavRegistryItem[] = [
  ...
  { nav_key: "monitoramento-solar", label_default: "Monitoramento Solar", group_default: "Integrações", order_default: 0.5, icon: "Sun", description: "Monitore usinas fotovoltaicas via Solarman e outros provedores", keywords: ["monitoramento", "solar", "solarman", "usina", "planta", "inversor", "produção"], criticality: "normal", permission: "admin_only" },
