...
export const NAV_REGISTRY: NavRegistryItem[] = [
  ...
  { nav_key: "config", label_default: "Calculadora Solar", group_default: "Cadastros", order_default: 5, icon: "Calculator", description: "Parâmetros de cálculo de geração e payback", keywords: ["calculadora", "cálculo", "geração", "payback", "simulação"], criticality: "normal", permission: "admin_only", separator: true },
