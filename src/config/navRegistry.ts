...
export const NAV_REGISTRY: NavRegistryItem[] = [
  ...
  { nav_key: "modulos", label_default: "Módulos Fotovoltaicos", group_default: "Cadastros", order_default: 1, icon: "Sun", description: "Catálogo de painéis e módulos solares (com auditoria)", keywords: ["módulo", "painel", "placa", "solar", "fotovoltaico", "auditoria", "datasheet"], criticality: "normal", permission: "admin_only" },
  { nav_key: "inversores-cadastro", label_default: "Inversores", group_default: "Cadastros", order_default: 2, icon: "Cpu", description: "Catálogo de inversores solares (com auditoria)", keywords: ["inversor", "string", "microinversor", "potência", "auditoria", "datasheet"], criticality: "normal", permission: "admin_only" },
  { nav_key: "baterias", label_default: "Baterias", group_default: "Cadastros", order_default: 3, icon: "Battery", description: "Catálogo de baterias e armazenamento (com auditoria)", keywords: ["bateria", "armazenamento", "storage", "energia", "auditoria"], criticality: "normal", permission: "admin_only" },
  { nav_key: "otimizadores", label_default: "Otimizadores", group_default: "Cadastros", order_default: 3.5, icon: "Zap", description: "Catálogo de otimizadores de potência (com auditoria)", keywords: ["otimizador", "optimizer", "solaredge", "potência", "mppt", "auditoria"], criticality: "normal", permission: "admin_only" },
