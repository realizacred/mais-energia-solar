...
export const NAV_REGISTRY: NavRegistryItem[] = [
  ...
  { nav_key: "gd-rateio", label_default: "GD e Rateio", group_default: "Energia", order_default: 6, icon: "Sun", description: "Geração distribuída, beneficiárias e rateio de créditos", keywords: ["GD", "geração", "distribuída", "beneficiária", "rateio", "crédito", "compensação"], criticality: "normal", permission: "admin_only" },
  { nav_key: "solarmarket", label_default: "SolarMarket Importação", group_default: "Integrações", order_default: 9, icon: "Sun", description: "Importar clientes, projetos e propostas do SolarMarket", keywords: ["solarmarket", "importar", "cliente", "projeto", "proposta", "sincronizar"], criticality: "normal", permission: "admin_only", separator: true },
  ...
  { nav_key: "wa-health", label_default: "Saúde WhatsApp", group_default: "Integrações", order_default: 10, icon: "Activity", description: "Status e saúde das conexões WhatsApp", keywords: ["whatsapp", "saúde", "health", "status", "conexão"], criticality: "normal", permission: "admin_only" },
  { nav_key: "payment-gateway", label_default: "Gateway de Pagamento", group_default: "Integrações", order_default: 12, icon: "CreditCard", description: "Configuração de gateway de pagamento (Asaas)", keywords: ["pagamento", "gateway", "asaas", "boleto", "pix", "cobrança"], criticality: "normal", permission: "admin_only" },
  { nav_key: "meta-facebook-config", label_default: "Config Meta/Facebook", group_default: "Integrações", order_default: 14, icon: "Globe", description: "Credenciais e configuração Meta/Facebook Ads", keywords: ["meta", "facebook", "ads", "configuração", "token", "pixel"], criticality: "normal", permission: "admin_only" },
  ...
  { nav_key: "variaveis-sistema", label_default: "Variáveis do Sistema", group_default: "Configurações", order_default: 4, icon: "Variable", description: "Catálogo completo de variáveis para templates de proposta e documentos", keywords: ["variável", "template", "placeholder", "catálogo", "chave", "variáveis"], criticality: "normal", permission: "admin_only" },
