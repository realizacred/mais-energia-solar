...
export const PROVIDER_REGISTRY: ProviderDefinition[] = ([
  ...
  {
    id: "livoltek", label: "Livoltek", description: "Inversores Livoltek/Axitec via API oficial.",
    icon: "Sun", category: "monitoring", status: "active", auth_type: "api_token",
    fields: [
      { key: "username", label: "Usuário", type: "text", placeholder: "E-mail ou login do portal Livoltek", required: true },
      { key: "password", label: "Senha", type: "password", placeholder: "Senha do portal", required: true },
      { key: "apiKey", label: "Api Key (key)", type: "text", placeholder: "Security Key da API", required: true, helperText: "Campo 'key' fornecido pela Livoltek" },
      { key: "appSecret", label: "App Secret (secuid)", type: "password", placeholder: "Security ID da aplicação", required: true, helperText: "Campo 'secuid' fornecido pela Livoltek" },
    ],
    capabilities: BASIC_CAP,
    tutorial: "1. Acesse o portal Livoltek (api.livoltek-portal.com)\n2. Obtenha o App Secret (secuid) e a Api Key (key) com o suporte Livoltek\n3. Use seu e-mail e senha do portal como Usuário e Senha",
    api_docs_url: "https://api.livoltek-portal.com:8081",
  },
  ...
  {
    id: "livoltek_cf", label: "Livoltek Cliente Final", description: "Portal Livoltek para clientes finais via API.",
    icon: "Sun", category: "monitoring", status: "active", auth_type: "api_token",
    fields: [
      { key: "username", label: "Usuário", type: "text", placeholder: "E-mail ou login do portal Livoltek", required: true },
      { key: "password", label: "Senha", type: "password", placeholder: "Senha do portal", required: true },
      { key: "apiKey", label: "Api Key (key)", type: "text", placeholder: "Security Key da API", required: true },
      { key: "appSecret", label: "App Secret (secuid)", type: "password", placeholder: "Security ID da aplicação", required: true },
    ],
    capabilities: BASIC_CAP,
  },
