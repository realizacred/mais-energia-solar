...
export const PROVIDER_REGISTRY: ProviderDefinition[] = ([
  ...
  stubProvider("solarview", "SolarView", "Monitoramento SolarView para micro/string inversores."),
  {
    ...
    fields: [
      { key: "apiKey", label: "Api Key (Chave Api / key)", type: "text", placeholder: "Security Key da API", required: true, helperText: "Campo 'key' da API Livoltek" },
      { key: "appSecret", label: "App Secret (secuid)", type: "password", placeholder: "Security ID da aplicação", required: true, helperText: "Campo 'secuid' da API Livoltek" },
    ],
