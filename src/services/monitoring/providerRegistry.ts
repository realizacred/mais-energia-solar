...
export const PROVIDER_REGISTRY: ProviderDefinition[] = ([
  ...
  stubProvider("solarview", "SolarView", "Monitoramento SolarView para micro/string inversores."),
  {
    ...
    fields: [
      { key: "apiKey", label: "Api Key (Chave Api)", type: "text", placeholder: "Sua chave de API", required: true },
      { key: "appSecret", label: "App Secret (Segredo da Aplicação)", type: "password", placeholder: "Segredo da aplicação", required: true },
      { key: "username", label: "Usuário", type: "text", placeholder: "Seu usuário Livoltek", required: false },
      { key: "userToken", label: "User Token (Token do Usuário)", type: "text", placeholder: "Token do usuário", required: false },
      { key: "password", label: "Senha", type: "password", placeholder: "Sua senha", required: false },
    ],
