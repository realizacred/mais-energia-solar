...
function getPhaseInfo(status: string | null | undefined): { label: string; color: string; badgeClass: string } {
  ...
  switch (num) {
    case 0: return { label: "Normal", color: "text-success", badgeClass: "bg-success/10 text-success border-success/20" };
    case 1: return { label: "Alarme", color: "text-warning", badgeClass: "bg-warning/10 text-warning border-warning/20" };
