                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="relative shrink-0">
                      <div className={`w-10 h-10 rounded-full flex items-center justify-center text-xs font-bold ${hasUnread ? "bg-primary/15 text-primary" : "bg-muted text-muted-foreground"}`}>
