...
export function PromocaoSolarmarketSection() {
  ...
  return (
    <section className="space-y-4">
      ...
      {/* Migração unificada agora vive em /admin/migracao-solarmarket/migrar (Step 3 — 1 clique). */}
      ...
      <div className="flex items-start gap-3 p-4 rounded-lg border border-warning/40 bg-warning/5">
        ...
        <div className="text-sm flex-1">
          <p className="font-semibold text-foreground">🚧 Sistema em reconstrução</p>
          <p className="text-xs text-muted-foreground mt-1">
            A promoção está sendo reformulada com mapeamento correto de funis e consultores.
            Os botões de execução foram desativados até a nova versão. Você ainda pode inspecionar
            o staging, o histórico e a configuração.
          </p>
        </div>
      </div>

      {/* KPIs agregados — mantidos visíveis para diagnóstico */}
