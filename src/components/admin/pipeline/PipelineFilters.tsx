  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex gap-2">
        ...
        {activeFiltersCount > 0 && (
          <Button variant="ghost" size="icon" onClick={onClearFilters} className="h-10 w-10">
            <X className="h-4 w-4" />
          </Button>
        )}
      </div>
          ...
          <div className="space-y-1.5">
            ...
            <Select value={consumoRange} onValueChange={onConsumoRangeChange}>
              ...
              <SelectContent>
                ...
                <SelectItem value="600-1000">600 – 1.000 kWh</SelectItem>
                <SelectItem value="1000+">Acima de 1.000 kWh</SelectItem>
              </SelectContent>
            </Select>
          </div>
