...
import { ChevronDown, Search, LayoutTemplate, Columns3, LayoutGrid, AlignLeft, ImageIcon, Play, RectangleHorizontal, Minus, GalleryHorizontal, ListCollapse, PanelTop, User, FileText, MapPin, Zap, Sun, Cable, Battery, Building, BarChart3, DollarSign, TrendingUp, Clock, Phone, Calendar, PiggyBank, Table2, Sparkles, Blocks, Braces } from "lucide-react";
...
// System widgets (solar domain) — using {{var}} canonical format
const SYSTEM_WIDGETS: WidgetRegistryEntry[] = [
  { key: "editor" as BlockType, label: "Dados do Cliente", icon: "User", category: "system", defaultBlock: { type: "editor", content: "<p>{{cliente_nome}}</p>", isVisible: true }, allowedParents: ["column", "inner_section"], requiredVariables: ["cliente_nome"] },
  { key: "editor" as BlockType, label: "Dados da Proposta", icon: "FileText", category: "system", defaultBlock: { type: "editor", content: "<p>Proposta {{proposta_identificador}}</p>", isVisible: true }, allowedParents: ["column", "inner_section"], requiredVariables: ["proposta_identificador"] },
  { key: "editor" as BlockType, label: "Localização", icon: "MapPin", category: "system", defaultBlock: { type: "editor", content: "<p>{{cliente_endereco}}, {{cliente_cidade}} - {{cliente_estado}}</p>", isVisible: true }, allowedParents: ["column", "inner_section"] },
  ...
  { key: "editor" as BlockType, label: "Painéis Solares", icon: "Sun", category: "system", defaultBlock: { type: "editor", content: "<p>{{qtde_modulos}}x {{modulo_modelo}} {{modulo_potencia}}</p>", isVisible: true }, allowedParents: ["column", "inner_section"] },
  { key: "editor" as BlockType, label: "Inversor On-Grid", icon: "Cable", category: "system", defaultBlock: { type: "editor", content: "<p>{{inversor_modelo}}</p>", isVisible: true }, allowedParents: ["column", "inner_section"] },
  { key: "editor" as BlockType, label: "Inversor Híbrido", icon: "Cable", category: "system", defaultBlock: { type: "editor", content: "<p>{{inversor_hibrido_modelo}}</p>", isVisible: true }, allowedParents: ["column", "inner_section"] },
  { key: "editor" as BlockType, label: "Banco de Baterias", icon: "Battery", category: "system", defaultBlock: { type: "editor", content: "<p>{{bateria_modelo}}</p>", isVisible: true }, allowedParents: ["column", "inner_section"] },
  ...
  { key: "editor" as BlockType, label: "Investimento", icon: "DollarSign", category: "system", defaultBlock: { type: "editor", content: "<p>Investimento: R$ {{valor_total}}</p>", isVisible: true }, allowedParents: ["column", "inner_section"] },
