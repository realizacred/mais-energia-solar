    ...
    <div className="space-y-5">
      ...
      <ScrollArea className="w-full">
        <div className="flex gap-4 pb-4 px-1" style={{ minWidth: "max-content" }}>
          {sorted.map((etapa, i) => {
            ...
            return (
              <div
                ...
                className={cn(
                  "w-[210px] flex-shrink-0 rounded-2xl border-2 p-4 transition-all duration-150",
              ...
              >
                ...
                <div className="flex items-center justify-between mb-3">
                  <span className="text-[10px] font-bold text-muted-foreground bg-background/80 rounded-full px-2.5 py-1">
                    Etapa #{i + 1}
                  </span>
                ...
                {editingId === etapa.id ? (
                  <div className="space-y-2.5">
                    ...
                    <div className="flex gap-1.5">
                      <Button variant="ghost" size="icon" className="h-8 w-8" onClick={() => handleRename(etapa.id)}>
                  ...
                  <h4 className="text-sm font-bold text-foreground truncate mb-3" title={etapa.nome}>
                    {etapa.nome}
                  </h4>
                )}
          ...
          {/* Add new card */}
          {showCreate ? (
            <div className="w-[230px] flex-shrink-0 rounded-2xl border-2 border-dashed border-primary/30 p-4 bg-primary/5 space-y-3">
              <Input
                value={newName}
              ...
              <div className="flex gap-1.5">
                <Button size="sm" className="h-9 flex-1 text-xs" onClick={handleCreate}>
                  <Check className="h-3.5 w-3.5 mr-1" />
                  Criar
                </Button>
                <Button variant="ghost" size="icon" className="h-9 w-9" onClick={() => { setShowCreate(false); setNewName(""); }}>
                  <X className="h-4 w-4" />
                </Button>
              </div>
            </div>
            ...
            <button
              ...
              className={cn(
                "w-[160px] flex-shrink-0 rounded-2xl border-2 border-dashed border-primary/30",
