...
function ProjetoDetalheContent() {
  ...
  return (
    <div className="min-h-screen bg-muted/30 -m-4 sm:-m-6 p-3 sm:p-6 max-w-full overflow-x-hidden">
      ...
      {/* ── Banner de reabertura comercial (REMOVIDO conforme solicitado na FASE 1, movido para ⋮) ── */}
    ...
    <>
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
        ...
        <div className="lg:col-span-5 xl:col-span-4 space-y-4">
          ...
          <Card>
            <CardHeader className="p-3 sm:p-3 pb-1 sm:pb-1 flex flex-row items-center justify-between space-y-0">
