...
export const VARIABLES_CATALOG: CatalogVariable[] = [
  ...
  v("comercial", "comercial.proposta_descricao", "descricao", "Descrição da Proposta", "Descrição/observações da proposta", "-", "Proposta para instalação residencial"),
  ...
  // REMOVIDO: duplicata de proposta_status (já existe na linha 1086)
  ...
  // ── Simulação (complementares — implementadas) ──
  ...
  v("pagamento", "pagamento.forma_entrada", "pagamento_forma_entrada", "Forma de Pagamento da Entrada", "Forma de pagamento utilizada na entrada (ex: PIX, Boleto)", "-", "PIX", "BT e MT", { escopo: "documento" }),
  v("pagamento", "pagamento.data_vencimento_entrada", "pagamento_data_venc_entrada", "Data Vencimento Entrada", "Data do vencimento da entrada", "data", "15/03/2026", "BT e MT", { escopo: "documento" }),
  v("pagamento", "pagamento.valor_restante", "pagamento_valor_restante", "Valor Restante", "Valor que falta pagar (Total - Entrada)", "R$", "R$ 10.450,00", "BT e MT", { escopo: "documento" }),
  v("pagamento", "pagamento.forma_restante", "pagamento_forma_restante", "Forma de Pagamento do Restante", "Forma de pagamento utilizada no restante (ex: Cartão)", "-", "Cartão de Crédito", "BT e MT", { escopo: "documento" }),
  v("pagamento", "pagamento.data_vencimento_restante", "pagamento_data_venc_restante", "Data Vencimento Restante", "Data prevista para pagamento do restante", "data", "15/04/2026", "BT e MT", { escopo: "documento" }),
  ...
  v("pagamento", "pagamento.parcelas_descricao", "pagamento_parcelas_descricao", "Descrição das Parcelas", "Descrição humanizada (ex: 12x de R$ 870,83 no cartão)", "-", "12x de R$ 870,83 no cartão", "BT e MT", { escopo: "documento" }),
  v("pagamento", "pagamento.valor_equipamento", "pagamento_valor_equipamento", "Valor Equipamento", "Valor do kit fotovoltaico", "R$", "R$ 10.000,00", "BT e MT", { escopo: "documento" }),
  v("pagamento", "pagamento.valor_mao_obra", "pagamento_valor_mao_obra", "Valor Mão de Obra", "Valor da mão de obra/serviço", "R$", "R$ 4.450,00", "BT e MT", { escopo: "documento" }),
  ...
  // ──────────────────────────────────────────────────────────────
  // ── Consumo e Geração ──
  v("customizada", "customizada.vc_consumo", "vc_consumo", "Consumo BT/MT", "Consumo em Baixa e Média Tensão unificado (IF BT/MT)", "kWh", "1000", "BT e MT", { notImplemented: true }),
  v("customizada", "customizada.vc_aumento", "vc_aumento", "Aumento da Geração vs Consumo", "Percentual de aumento da geração em relação ao consumo", "%", "120", "BT e MT", { notImplemented: true }),
  v("customizada", "customizada.vc_media_sonsumo_mensal", "vc_media_sonsumo_mensal", "Média de Consumo Mensal", "Média de consumo mensal (alias de consumo_mensal)", "kWh", "500", "BT e MT", { notImplemented: true }),
  v("customizada", "customizada.vc_consumo_anual", "vc_consumo_anual", "Consumo Anual", "Soma dos 12 meses de consumo", "kWh", "6000", "BT e MT", { notImplemented: true }),
  v("customizada", "customizada.vc_economia_acumulada", "vc_economia_acumulada", "Economia Acumulada", "Soma da economia anual dos 25 anos", "R$", "250000", "BT e MT", { notImplemented: true }),

  // ── Séries Consumo/Geração ──
  v("customizada", "customizada.vc_s_consumo_mensal_media", "vc_s_consumo_mensal_media", "Consumo Mensal com Média", "Série de consumo mensal (jan-dez) + média", "kWh", "{500,480,...}", "BT e MT", { notImplemented: true }),
  v("customizada", "customizada.vc_s_consumo_mt_p", "vc_s_consumo_mt_p", "Consumo Anual Ponta", "Série de consumo mensal Ponta (MT)", "kWh", "{100,110,...}", "BT e MT", { notImplemented: true }),
  v("customizada", "customizada.vc_s_consumo_mt_fp", "vc_s_consumo_mt_fp", "Consumo Anual Fora Ponta", "Série de consumo mensal Fora Ponta (MT)", "kWh", "{400,390,...}", "BT e MT", { notImplemented: true }),
  v("customizada", "customizada.vc_s_consumo_mt_p_e_fp", "vc_s_consumo_mt_p_e_fp", "Consumo Anual MT", "Série de consumo mensal Ponta + Fora Ponta (MT)", "kWh", "{500,500,...}", "BT e MT", { notImplemented: true }),
  v("customizada", "customizada.vc_s_geracao_mensal_media", "vc_s_geracao_mensal_media", "Geração Mensal com Média", "Série de geração mensal (jan-dez) + média", "kWh", "{550,520,...}", "BT e MT", { notImplemented: true }),

  // ── Financeiro / Pagamento ──
  v("customizada", "customizada.vc_a_vista", "vc_a_vista", "Preço à Vista", "Preço com desconto à vista aplicado", "R$", "40000", "BT e MT", { notImplemented: true }),
  v("customizada", "customizada.vc_valor_entrada", "vc_valor_entrada", "Valor Entrada", "Valor de entrada (kit_fechado_preco_total)", "R$", "15000", "BT e MT", { notImplemented: true }),
  v("customizada", "customizada.vc_valor_parcelas_4", "vc_valor_parcelas_4", "Valor das Parcelas", "Valor das parcelas ((preco - entrada) / 3)", "R$", "5000", "BT e MT", { notImplemented: true }),
  v("customizada", "customizada.vc_valor_parcela_troca_medidor", "vc_valor_parcela_troca_medidor", "Valor Parcela Após Troca Medidor", "Valor à vista menos entrada", "R$", "10000", "BT e MT", { notImplemented: true }),

  // ── Indicadores Financeiros ──
  v("customizada", "customizada.vc_saldo_solar_25_anos", "vc_saldo_solar_25_anos", "Saldo Solar 25 anos", "Fluxo de caixa acumulado ano 24", "R$", "350000", "BT e MT", { notImplemented: true }),
  v("customizada", "customizada.vc_saldo_renda_fixa_25_anos", "vc_saldo_renda_fixa_25_anos", "Saldo Renda Fixa 25 anos", "Investimento equivalente em renda fixa (7.4% a.a.) por 25 anos", "R$", "250000", "BT e MT", { notImplemented: true }),
  v("customizada", "customizada.vc_saldo_poupanca_25_anos", "vc_saldo_poupanca_25_anos", "Saldo Poupança 25 anos", "Investimento equivalente em poupança (4.5% a.a.) por 25 anos", "R$", "150000", "BT e MT", { notImplemented: true }),
  v("customizada", "customizada.vc_roi_primeiro_mes", "vc_roi_primeiro_mes", "ROI 1º mês", "Retorno sobre investimento no primeiro mês (%)", "%", "0.5", "BT e MT", { notImplemented: true }),
  v("customizada", "customizada.vc_tarifa_solar", "vc_tarifa_solar", "Tarifa Solar", "Custo efetivo por kWh com solar ao longo de 25 anos", "R$/kWh", "0.15", "BT e MT", { notImplemented: true }),
  v("customizada", "customizada.vc_preco_watt", "vc_preco_watt", "Preço Watt", "Valor do investimento por Watt instalado", "R$/W", "4.50", "BT e MT", { notImplemented: true }),
  v("customizada", "customizada.vc_investimento_solar_rendimento", "vc_investimento_solar_rendimento", "Rendimento Investimento Solar (%)", "Rendimento percentual do investimento solar no ano 0", "%", "25", "BT e MT", { notImplemented: true }),
  v("customizada", "customizada.vc_economia_conta_total_rs", "vc_economia_conta_total_rs", "Economia Conta Total MT (R$)", "Economia total na conta MT (gasto atual - gasto novo)", "R$", "1500", "BT e MT", { notImplemented: true }),
  v("customizada", "customizada.vc_economia_conta_total_pc", "vc_economia_conta_total_pc", "Economia Conta Total (%)", "Percentual de economia na conta MT", "%", "85", "BT e MT", { notImplemented: true }),

  // ── Financiamento / Banco ──
  v("customizada", "customizada.vc_nome", "vc_nome", "Nome do Cliente (legado)", "Nome do cliente — alias legado usado em templates antigos. Para banco/financeira, use vc_financeira_nome.", "-", "João da Silva", "BT e MT", { notImplemented: true }),
  v("customizada", "customizada.vc_financeira_nome", "vc_financeira_nome", "Nome do Banco/Financeira", "Nome do banco ou financeira ativo no financiamento", "-", "BV", "BT e MT", { notImplemented: true }),
  v("customizada", "customizada.vc_taxa_1", "vc_taxa_1", "Taxa 1", "Taxa de juros condição 1 (SWITCH por banco)", "%", "1.99", "BT e MT", { notImplemented: true }),
  v("customizada", "customizada.vc_taxa_2", "vc_taxa_2", "Taxa 2", "Taxa de juros condição 2 (SWITCH por banco)", "%", "2.49", "BT e MT", { notImplemented: true }),
  v("customizada", "customizada.vc_taxa_3", "vc_taxa_3", "Taxa 3", "Taxa de juros condição 3 (SWITCH por banco)", "%", "2.99", "BT e MT", { notImplemented: true }),
  v("customizada", "customizada.vc_entrada_1", "vc_entrada_1", "Entrada 1", "Entrada condição 1 (SWITCH por banco)", "R$", "5000", "BT e MT", { notImplemented: true }),
  v("customizada", "customizada.vc_entrada_2", "vc_entrada_2", "Entrada 2", "Entrada condição 2 (SWITCH por banco)", "R$", "3000", "BT e MT", { notImplemented: true }),
  v("customizada", "customizada.vc_entrada_3", "vc_entrada_3", "Entrada 3", "Entrada condição 3 (SWITCH por banco)", "R$", "1000", "BT e MT", { notImplemented: true }),
  v("customizada", "customizada.vc_prazo_1", "vc_prazo_1", "Prazo 1", "Prazo condição 1 (SWITCH por banco)", "meses", "24", "BT e MT", { notImplemented: true }),
  v("customizada", "customizada.vc_prazo_2", "vc_prazo_2", "Prazo 2", "Prazo condição 2 (SWITCH por banco)", "meses", "36", "BT e MT", { notImplemented: true }),
  v("customizada", "customizada.vc_prazo_3", "vc_prazo_3", "Prazo 3", "Prazo condição 3 (SWITCH por banco)", "meses", "48", "BT e MT", { notImplemented: true }),
  v("customizada", "customizada.vc_parcela_1", "vc_parcela_1", "Parcela 1", "Parcela condição 1 (SWITCH por banco)", "R$", "1500", "BT e MT", { notImplemented: true }),
  v("customizada", "customizada.vc_parcela_2", "vc_parcela_2", "Parcela 2", "Parcela condição 2 (SWITCH por banco)", "R$", "1200", "BT e MT", { notImplemented: true }),
  v("customizada", "customizada.vc_parcela_3", "vc_parcela_3", "Parcela 3", "Parcela condição 3 (SWITCH por banco)", "R$", "1000", "BT e MT", { notImplemented: true }),

  // ── Equipamentos ──
  v("customizada", "customizada.vc_total_modulo", "vc_total_modulo", "Total Módulos", "Quantidade total de módulos calculada", "-", "16", "BT e MT", { notImplemented: true }),
  v("customizada", "customizada.vc_p_total_cc", "vc_p_total_cc", "Potência Total CC", "Potência total CC dos inversores", "kW", "8.2", "BT e MT", { notImplemented: true }),
  v("customizada", "customizada.vc_string_box_cc", "vc_string_box_cc", "Incluir String Box CC", "Texto condicional sobre string box", "-", "Este inversor...", "BT e MT", { notImplemented: true }),
  v("customizada", "customizada.vc_potencia_sistema", "vc_potencia_sistema", "Potência Sistema Resumo", "Potência do sistema (alias)", "kWp", "8.2", "BT e MT", { notImplemented: true }),
  
  v("customizada", "customizada.vc_inversor_potencia_nominal", "vc_inversor_potencia_nominal", "Inversor Potência Nominal", "Potência nominal do inversor / 1000", "kW", "8.2", "BT e MT", { notImplemented: true }),
  v("customizada", "customizada.vc_estrutura", "vc_estrutura", "Estrutura", "Tipo de estrutura (alias cape_telhado)", "-", "Fibrocimento", "BT e MT", { notImplemented: true }),

  // ── Comercial ──
  v("customizada", "customizada.vc_garantiaservico", "vc_garantiaservico", "Garantia Serviço", "Tempo de garantia de serviço", "-", "2 ano", "BT e MT", { notImplemented: true }),
  v("customizada", "customizada.vc_grafico_de_comparacao", "vc_grafico_de_comparacao", "Gráfico de Comparação", "Dados para gráfico comparativo (gasto atual vs geração)", "-", "{15000, 12000}", "BT e MT", { notImplemented: true }),
  v("customizada", "customizada.vc_valor_gerac_prevista", "vc_valor_gerac_prevista", "Valor de Geração Prevista", "Tarifa distribuidora × geração mensal", "R$", "800", "BT e MT", { notImplemented: true }),

  // ── Cartão de Crédito ──
  v("customizada", "customizada.vc_cartao_credito_parcela_1", "vc_cartao_credito_parcela_1", "Cartão Crédito Parcela 1", "Parcela cartão 1x (à vista + taxa)", "R$", "45000", "BT e MT", { notImplemented: true }),
  v("customizada", "customizada.vc_cartao_credito_parcela_2", "vc_cartao_credito_parcela_2", "Cartão Crédito Parcela 2", "Parcela cartão 2x (à vista + taxa)", "R$", "23000", "BT e MT", { notImplemented: true }),
  v("customizada", "customizada.vc_cartao_credito_parcela_3", "vc_cartao_credito_parcela_3", "Cartão Crédito Parcela 3", "Parcela cartão 3x (à vista + taxa)", "R$", "16000", "BT e MT", { notImplemented: true }),
  v("customizada", "customizada.vc_cartao_credito_parcela_4", "vc_cartao_credito_parcela_4", "Cartão Crédito Parcela 4", "Parcela cartão 4x (à vista + taxa)", "R$", "12500", "BT e MT", { notImplemented: true }),
  v("customizada", "customizada.vc_cartao_credito_taxa_1", "vc_cartao_credito_taxa_1", "Cartão Crédito Taxa 1", "Taxa cartão 1x (7%)", "%", "7", "BT e MT", { notImplemented: true }),
  v("customizada", "customizada.vc_cartao_credito_taxa_2", "vc_cartao_credito_taxa_2", "Cartão Crédito Taxa 2", "Taxa cartão 2x (11%)", "%", "11", "BT e MT", { notImplemented: true }),
  v("customizada", "customizada.vc_cartao_credito_taxa_3", "vc_cartao_credito_taxa_3", "Cartão Crédito Taxa 3", "Taxa cartão 3x (15%)", "%", "15", "BT e MT", { notImplemented: true }),
  v("customizada", "customizada.vc_cartao_credito_taxa_4", "vc_cartao_credito_taxa_4", "Cartão Crédito Taxa 4", "Taxa cartão 4x (17%)", "%", "17", "BT e MT", { notImplemented: true }),

  // ── ICMS / Impostos ──
  v("customizada", "customizada.vc_cal_icms_enel", "vc_cal_icms_enel", "Cálculo ICMS Enel", "Alíquota ICMS condicional por faixa de gasto", "%", "25", "BT e MT", { notImplemented: true }),
  v("customizada", "customizada.vc_valor_icms_enel", "vc_valor_icms_enel", "Valor ICMS Enel (R$)", "Valor do ICMS calculado em reais", "R$", "150", "BT e MT", { notImplemented: true }),
  v("customizada", "customizada.vc_valor_icms_enel_fator_simultaneidade", "vc_valor_icms_enel_fator_simultaneidade", "ICMS Enel c/ Fator Simultaneidade", "Valor ICMS ajustado pelo fator de simultaneidade", "R$", "135", "BT e MT", { notImplemented: true }),

  // ── Seguro ──
  v("customizada", "customizada.vc_incluir_seguro", "vc_incluir_seguro", "Incluir Seguro", "Condicional para inclusão de seguro (Sim/Não)", "-", "Sim", "BT e MT", { notImplemented: true }),
  v("customizada", "customizada.vc_calculo_seguro", "vc_calculo_seguro", "Cálculo Seguro", "Valor calculado do seguro por período", "R$", "500", "BT e MT", { notImplemented: true }),
...
export const PROPOSAL_MESSAGE_VARIABLES: ChannelVariable[] = [
  ...
  { key: "{{proposta_link}}", label: "Link da proposta (alias)", example: "https://app.com/pl/abc123", category: "Proposta" },
  { key: "{{link_pdf}}", label: "Link público do PDF", example: "https://app.com/p/pdf/abc123", category: "Proposta" },
  { key: "{{pdf_link}}", label: "Link do PDF (alias)", example: "https://app.com/p/pdf/abc123", category: "Proposta" },
