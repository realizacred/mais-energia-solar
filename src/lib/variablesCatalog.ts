...
export const VARIABLES_CATALOG: CatalogVariable[] = [
  ...
  v("comercial", "comercial.proposta_link", "proposta_link", "Link da Proposta", "URL de visualização pública da proposta", "-", "https://...", { notImplemented: true }),
  ...
  v("comercial", "comercial.projeto_id_externo", "projeto_id_externo", "Identificador externo do Projeto", "ID do projeto em sistema externo", "-", "123123", { notImplemented: true }),
  v("comercial", "comercial.empresa_nome", "empresa_nome", "Empresa do integrador", "Razão social da empresa", "-", "Cruzeiro Esporte Clube"),
  v("comercial", "comercial.empresa_cnpj_cpf", "empresa_cnpj_cpf", "CNPJ/CPF do integrador", "CNPJ ou CPF da empresa", "-", "44.490.706/0001-54", { notImplemented: true }),
  v("comercial", "comercial.empresa_cidade", "empresa_cidade", "Cidade do integrador", "Cidade da empresa", "-", "Belo Horizonte", { notImplemented: true }),
  v("comercial", "comercial.empresa_estado", "empresa_estado", "Estado do integrador", "Estado da empresa", "-", "MG", { notImplemented: true }),
  v("comercial", "comercial.empresa_endereco", "empresa_endereco", "Endereço do integrador", "Endereço completo da empresa", "-", "Rua Solar, 100", { notImplemented: true }),
  v("comercial", "comercial.empresa_telefone", "empresa_telefone", "Telefone do integrador", "Telefone da empresa", "-", "(31) 3333-0000", { notImplemented: true }),
  v("comercial", "comercial.empresa_email", "empresa_email", "E-mail do integrador", "Email da empresa", "-", "contato@solartech.com", { notImplemented: true }),
  v("comercial", "comercial.empresa_logo_url", "empresa_logo_url", "Logo da empresa", "URL do logotipo da empresa", "-", "https://...", { notImplemented: true }),

  // ── Deal / Negócio ──
  v("comercial", "comercial.deal_title", "deal_title", "Título do Projeto", "Título do deal/negócio no pipeline", "-", "Projeto Solar Residencial", { notImplemented: true }),
  v("comercial", "comercial.deal_status", "deal_status", "Status do Negócio", "Status do deal (open, won, lost)", "-", "open", { notImplemented: true }),
  v("comercial", "comercial.deal_etiqueta", "deal_etiqueta", "Etiqueta do Projeto", "Etiqueta/tag do deal no pipeline", "-", "Urgente", { notImplemented: true }),
  v("comercial", "comercial.deal_notas", "deal_notas", "Notas do Negócio", "Notas e observações do deal", "-", "Cliente com urgência", { notImplemented: true }),
  v("comercial", "comercial.deal_expected_close_date", "deal_expected_close_date", "Previsão de Fechamento", "Data prevista de fechamento do negócio", "data", "30/04/2026", { notImplemented: true }),

  // ── Proposta (complementares) ──
  v("comercial", "comercial.proposta_num", "proposta_num", "Número da Proposta", "Número sequencial da proposta", "-", "42", { notImplemented: true }),
  v("comercial", "comercial.proposta_status", "proposta_status", "Status da Proposta", "Status atual da proposta (rascunho, enviada, aceita, etc.)", "-", "enviada", { notImplemented: true }),
  v("comercial", "comercial.proposta_valido_ate", "proposta_valido_ate", "Proposta Válida Até", "Data limite de validade da proposta", "data", "30/04/2026", { notImplemented: true }),
  v("comercial", "comercial.proposta_link_pdf", "proposta_link_pdf", "Link do PDF da Proposta", "URL para download do PDF da proposta", "-", "https://...", { notImplemented: true }),
  v("comercial", "comercial.proposta_aceita_at", "proposta_aceita_at", "Data de Aceite da Proposta", "Data em que a proposta foi aceita pelo cliente", "data", "15/03/2026", { notImplemented: true }),
  v("comercial", "comercial.proposta_enviada_at", "proposta_enviada_at", "Data de Envio da Proposta", "Data em que a proposta foi enviada ao cliente", "data", "10/03/2026", { notImplemented: true }),
  v("comercial", "comercial.proposta_recusa_motivo", "proposta_recusa_motivo", "Motivo de Recusa", "Motivo pelo qual a proposta foi recusada", "-", "Preço elevado", { notImplemented: true }),
  v("comercial", "comercial.proposta_recusada_at", "proposta_recusada_at", "Data de Recusa", "Data em que a proposta foi recusada", "data", "20/03/2026", { notImplemented: true }),
  v("comercial", "comercial.proposta_regra_gd", "proposta_regra_gd", "Regra GD Aplicada", "Regra de geração distribuída aplicada no cálculo", "-", "Lei 14.300", { notImplemented: true }),
  v("comercial", "comercial.proposta_origem_tarifa", "proposta_origem_tarifa", "Origem da Tarifa", "Fonte de dados da tarifa utilizada no cálculo", "-", "ANEEL", { notImplemented: true }),
  v("comercial", "comercial.proposta_precisao_calculo", "proposta_precisao_calculo", "Precisão do Cálculo", "Nível de precisão do cálculo da proposta", "-", "alta", { notImplemented: true }),
  v("comercial", "comercial.proposta_precisao_motivo", "proposta_precisao_motivo", "Motivo da Precisão", "Motivo da classificação de precisão do cálculo", "-", "Tarifa ANEEL atualizada", { notImplemented: true }),
  v("comercial", "comercial.proposta_versao_atual", "proposta_versao_atual", "Versão Atual da Proposta", "Número da versão atual da proposta", "-", "3", { notImplemented: true }),

  // ── Versão da Proposta (complementares) ──
  v("comercial", "comercial.proposta_inflacao_energetica", "proposta_inflacao_energetica", "Inflação Energética (%)", "Premissa de inflação energética usada na proposta", "%", "6.5", { notImplemented: true }),
  v("comercial", "comercial.proposta_perda_eficiencia_anual", "proposta_perda_eficiencia_anual", "Perda de Eficiência Anual (%)", "Premissa de perda de eficiência anual do sistema", "%", "0.7", { notImplemented: true }),
  v("comercial", "comercial.proposta_sobredimensionamento", "proposta_sobredimensionamento", "Sobredimensionamento (%)", "Percentual de sobredimensionamento aplicado", "%", "10", { notImplemented: true }),
  v("comercial", "comercial.proposta_enviado_em", "proposta_enviado_em", "Versão Enviada Em", "Data de envio da versão da proposta", "data", "10/03/2026", { notImplemented: true }),
  v("comercial", "comercial.proposta_aceito_em", "proposta_aceito_em", "Versão Aceita Em", "Data de aceite da versão da proposta", "data", "15/03/2026", { notImplemented: true }),
  v("comercial", "comercial.proposta_rejeitado_em", "proposta_rejeitado_em", "Versão Rejeitada Em", "Data de rejeição da versão da proposta", "data", "20/03/2026", { notImplemented: true }),
  v("comercial", "comercial.proposta_motivo_rejeicao", "proposta_motivo_rejeicao", "Motivo de Rejeição da Versão", "Motivo de rejeição da versão da proposta", "-", "Valores incorretos", { notImplemented: true }),
  v("comercial", "comercial.proposta_output_docx_path", "proposta_output_docx_path", "Arquivo DOCX", "Caminho do arquivo DOCX gerado da proposta", "-", "propostas/v1.docx", { notImplemented: true }),
  v("comercial", "comercial.proposta_output_pdf_path", "proposta_output_pdf_path", "Arquivo PDF", "Caminho do arquivo PDF gerado da proposta", "-", "propostas/v1.pdf", { notImplemented: true }),
  v("comercial", "comercial.proposta_viewed_at", "proposta_viewed_at", "Visualizado Em", "Data em que a proposta foi visualizada pelo cliente", "data", "12/03/2026", { notImplemented: true }),
  v("comercial", "comercial.proposta_observacoes", "proposta_observacoes", "Observações da Proposta", "Observações e notas da proposta", "-", "Desconto negociado", { notImplemented: true }),
  v("comercial", "comercial.proposta_versao_status", "proposta_versao_status", "Status da Versão", "Status da versão da proposta (rascunho, enviada, aceita)", "-", "enviada", { notImplemented: true }),

  // ── Projeto (detalhes) ──
  v("comercial", "comercial.projeto_tipo_instalacao", "projeto_tipo_instalacao", "Tipo de Instalação", "Tipo de instalação do projeto (Residencial, Comercial, etc.)", "-", "Residencial", { notImplemented: true }),
  v("comercial", "comercial.projeto_valor_equipamentos", "projeto_valor_equipamentos", "Valor Equipamentos", "Valor total dos equipamentos do projeto", "R$", "30000.00", { notImplemented: true }),
  v("comercial", "comercial.projeto_valor_mao_obra", "projeto_valor_mao_obra", "Valor Mão de Obra", "Valor da mão de obra do projeto", "R$", "8000.00", { notImplemented: true }),
  v("comercial", "comercial.projeto_data_venda", "projeto_data_venda", "Data da Venda", "Data de fechamento da venda", "data", "01/03/2026", { notImplemented: true }),
  v("comercial", "comercial.projeto_data_previsao_instalacao", "projeto_data_previsao_instalacao", "Previsão de Instalação", "Data prevista para instalação do projeto", "data", "15/04/2026", { notImplemented: true }),
  v("comercial", "comercial.projeto_data_instalacao", "projeto_data_instalacao", "Data de Instalação", "Data efetiva da instalação do projeto", "data", "20/04/2026", { notImplemented: true }),
  v("comercial", "comercial.projeto_data_comissionamento", "projeto_data_comissionamento", "Data de Comissionamento", "Data de comissionamento do projeto", "data", "25/04/2026", { notImplemented: true }),
  v("comercial", "comercial.projeto_status", "projeto_status", "Status do Projeto", "Status atual do projeto (em andamento, concluído, etc.)", "-", "em_andamento", { notImplemented: true }),
  v("comercial", "comercial.projeto_forma_pagamento", "projeto_forma_pagamento", "Forma de Pagamento", "Forma de pagamento do projeto", "-", "Financiamento", { notImplemented: true }),
  v("comercial", "comercial.projeto_valor_entrada", "projeto_valor_entrada", "Valor de Entrada", "Valor de entrada do projeto", "R$", "10000.00", { notImplemented: true }),
  v("comercial", "comercial.projeto_valor_financiado", "projeto_valor_financiado", "Valor Financiado", "Valor financiado do projeto", "R$", "35000.00", { notImplemented: true }),
  v("comercial", "comercial.projeto_numero_parcelas", "projeto_numero_parcelas", "Nº de Parcelas", "Número de parcelas do financiamento do projeto", "UN", "60", { notImplemented: true }),
  v("comercial", "comercial.projeto_valor_parcela", "projeto_valor_parcela", "Valor da Parcela", "Valor mensal da parcela do projeto", "R$", "850.00", { notImplemented: true }),
  v("comercial", "comercial.projeto_prazo_estimado_dias", "projeto_prazo_estimado_dias", "Prazo Estimado (dias)", "Prazo estimado em dias para conclusão do projeto", "dias", "30", { notImplemented: true }),
  v("comercial", "comercial.projeto_prazo_vistoria_dias", "projeto_prazo_vistoria_dias", "Prazo Vistoria (dias)", "Prazo em dias para vistoria da concessionária", "dias", "15", { notImplemented: true }),

  // ── Projeto (endereço de instalação) ──
  v("comercial", "comercial.projeto_rua_instalacao", "projeto_rua_instalacao", "Rua Instalação", "Rua do local de instalação", "-", "Rua Solar", { notImplemented: true }),
  v("comercial", "comercial.projeto_numero_instalacao", "projeto_numero_instalacao", "Número Instalação", "Número do local de instalação", "-", "100", { notImplemented: true }),
  v("comercial", "comercial.projeto_complemento_instalacao", "projeto_complemento_instalacao", "Complemento Instalação", "Complemento do endereço de instalação", "-", "Galpão 2", { notImplemented: true }),
  v("comercial", "comercial.projeto_bairro_instalacao", "projeto_bairro_instalacao", "Bairro Instalação", "Bairro do local de instalação", "-", "Industrial", { notImplemented: true }),
  v("comercial", "comercial.projeto_cidade_instalacao", "projeto_cidade_instalacao", "Cidade Instalação", "Cidade do local de instalação", "-", "Belo Horizonte", { notImplemented: true }),
  v("comercial", "comercial.projeto_uf_instalacao", "projeto_uf_instalacao", "UF Instalação", "Estado/UF do local de instalação", "-", "MG", { notImplemented: true }),
  v("comercial", "comercial.projeto_cep_instalacao", "projeto_cep_instalacao", "CEP Instalação", "CEP do local de instalação", "-", "30130-000", { notImplemented: true }),
  v("comercial", "comercial.projeto_lat_instalacao", "projeto_lat_instalacao", "Latitude Instalação", "Latitude do local de instalação", "-", "-19.9167", { notImplemented: true }),
  v("comercial", "comercial.projeto_lon_instalacao", "projeto_lon_instalacao", "Longitude Instalação", "Longitude do local de instalação", "-", "-43.9345", { notImplemented: true }),
  v("comercial", "comercial.projeto_observacoes", "projeto_observacoes", "Observações do Projeto", "Observações e notas do projeto", "-", "Telhado com inclinação de 15°", { notImplemented: true }),
  ...
  v("comercial", "comercial.consultor_codigo", "consultor_codigo", "Código do Consultor", "Código identificador do consultor", "-", "CONS-001", { notImplemented: true }),

  // ── Concessionária (detalhes) ──
  v("comercial", "comercial.concessionaria_sigla", "concessionaria_sigla", "Sigla da Concessionária", "Sigla/abreviação da concessionária", "-", "CEMIG", { notImplemented: true }),
  v("comercial", "comercial.concessionaria_estado", "concessionaria_estado", "Estado da Concessionária", "Estado de atuação da concessionária", "-", "MG", { notImplemented: true }),
  v("comercial", "comercial.concessionaria_tarifa_fio_b", "concessionaria_tarifa_fio_b", "Tarifa Fio B da Concessionária", "Valor da tarifa Fio B da concessionária", "R$/kWh", "0.21", { notImplemented: true }),
  v("comercial", "comercial.concessionaria_custo_disponibilidade_monofasico", "concessionaria_custo_disponibilidade_monofasico", "Custo Disp. Monofásico", "Custo de disponibilidade monofásico da concessionária", "kWh", "30", { notImplemented: true }),
  v("comercial", "comercial.concessionaria_custo_disponibilidade_bifasico", "concessionaria_custo_disponibilidade_bifasico", "Custo Disp. Bifásico", "Custo de disponibilidade bifásico da concessionária", "kWh", "50", { notImplemented: true }),
  v("comercial", "comercial.concessionaria_custo_disponibilidade_trifasico", "concessionaria_custo_disponibilidade_trifasico", "Custo Disp. Trifásico", "Custo de disponibilidade trifásico da concessionária", "kWh", "100", { notImplemented: true }),
  v("comercial", "comercial.concessionaria_aliquota_icms", "concessionaria_aliquota_icms", "Alíquota ICMS", "Alíquota de ICMS da concessionária", "%", "18", { notImplemented: true }),
  v("comercial", "comercial.concessionaria_percentual_isencao", "concessionaria_percentual_isencao", "% Isenção SCEE", "Percentual de isenção SCEE da concessionária", "%", "100", { notImplemented: true }),
  v("comercial", "comercial.concessionaria_possui_isencao_scee", "concessionaria_possui_isencao_scee", "Possui Isenção SCEE", "Se a concessionária possui isenção SCEE", "-", "Sim", { notImplemented: true }),
  ...
  v("comercial", "comercial.simulacao_tipo_conta", "simulacao_tipo_conta", "Tipo de Conta", "Tipo de conta de energia da simulação", "-", "Residencial", { notImplemented: true }),
  v("comercial", "comercial.simulacao_co2_evitado_kg", "simulacao_co2_evitado_kg", "CO₂ Evitado (kg)", "Quantidade de CO₂ evitada pela geração solar", "kg", "5400", { notImplemented: true }),

  // ── Cliente (complementares) ──
  v("comercial", "comercial.cliente_observacoes", "cliente_observacoes", "Observações do Cliente", "Observações e notas sobre o cliente", "-", "Cliente preferencial", { notImplemented: true }),

  // ── Representante Legal da Empresa ──
  v("comercial", "comercial.empresa_representante_legal", "empresa_representante_legal", "Representante Legal", "Nome do representante legal da empresa", "-", "Carlos Alberto Silva", { notImplemented: true }),
  v("comercial", "comercial.empresa_representante_cpf", "empresa_representante_cpf", "CPF do Representante", "CPF do representante legal da empresa", "-", "123.456.789-00", { notImplemented: true }),
  v("comercial", "comercial.empresa_representante_cargo", "empresa_representante_cargo", "Cargo do Representante", "Cargo do representante legal (ex: Sócio-Diretor)", "-", "Sócio-Diretor", { notImplemented: true }),
  ...
  v("cliente", "cliente.data_nascimento", "cliente_data_nascimento", "Data de Nascimento", "Data de nascimento do cliente", "data", "15/05/1985", { notImplemented: true }),
  v("cliente", "cliente.potencia_kwp", "cliente_potencia_kwp", "Potência Instalada (kWp)", "Potência do sistema instalado no cliente", "kWp", "8.2", { notImplemented: true }),
  v("cliente", "cliente.valor_projeto", "cliente_valor_projeto", "Valor do Projeto", "Valor total do projeto do cliente", "R$", "45000.00", { notImplemented: true }),
  v("cliente", "cliente.data_instalacao", "cliente_data_instalacao", "Data de Instalação", "Data de instalação do sistema do cliente", "data", "20/03/2026", { notImplemented: true }),
  v("cliente", "cliente.numero_placas", "cliente_numero_placas", "Número de Placas", "Quantidade de módulos instalados no cliente", "UN", "20", { notImplemented: true }),
  v("cliente", "cliente.modelo_inversor", "cliente_modelo_inversor", "Modelo do Inversor", "Modelo do inversor instalado no cliente", "-", "SG36KTL-M", { notImplemented: true }),
