...
export const VARIABLES_CATALOG: CatalogVariable[] = [
  ...
  v("sistema_solar", "sistema_solar.modulo_potencia_numero", "modulo_potencia_numero", "Módulo Potência (número)", "Potência sem Wp — para templates com unidade hardcoded", "-", "320"),
  ...
  v("sistema_solar", "sistema_solar.modulo_comprimento_numero", "modulo_comprimento_numero", "Módulo Comprimento (número)", "Comprimento sem mm", "-", "1920"),
  v("sistema_solar", "sistema_solar.modulo_largura", "modulo_largura", "Módulo Largura", "Largura do módulo", "cm", "992"),
  v("sistema_solar", "sistema_solar.modulo_largura_numero", "modulo_largura_numero", "Módulo Largura (número)", "Largura sem mm", "-", "992"),
  v("sistema_solar", "sistema_solar.modulo_profundidade", "modulo_profundidade", "Módulo Profundidade", "Profundidade do módulo", "cm", "40"),
  v("sistema_solar", "sistema_solar.modulo_profundidade_numero", "modulo_profundidade_numero", "Módulo Profundidade (número)", "Profundidade sem mm", "-", "40"),
  ...
  v("financeiro", "financeiro.valor_total_numero", "valor_total_numero", "Valor Total (número)", "Valor sem R$ — para templates com unidade hardcoded", "-", "42.500,00"),
  v("financeiro", "financeiro.valor_kit_numero", "valor_kit_numero", "Valor Kit (número)", "Custo kit sem R$", "-", "28.000,00"),
  v("financeiro", "financeiro.valor_instalacao_numero", "valor_instalacao_numero", "Valor Instalação (número)", "Custo instalação sem R$", "-", "5.000,00"),
  ...
  v("comercial", "comercial.proposta_link", "proposta_link", "Link da Proposta", "URL de visualização pública da proposta", "-", "https://...", "BT e MT", { notImplemented: true }),
  ...
  v("comercial", "comercial.projeto_id_externo", "projeto_id_externo", "Identificador externo do Projeto", "ID do projeto em sistema externo", "-", "123123", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.empresa_nome", "empresa_nome", "Empresa do integrador", "Razão social da empresa", "-", "Cruzeiro Esporte Clube"),
  v("comercial", "comercial.empresa_cnpj_cpf", "empresa_cnpj_cpf", "CNPJ/CPF do integrador", "CNPJ ou CPF da empresa", "-", "44.490.706/0001-54", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.empresa_cidade", "empresa_cidade", "Cidade do integrador", "Cidade da empresa", "-", "Belo Horizonte", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.empresa_estado", "empresa_estado", "Estado do integrador", "Estado da empresa", "-", "MG", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.empresa_endereco", "empresa_endereco", "Endereço do integrador", "Endereço completo da empresa", "-", "Rua Solar, 100", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.empresa_telefone", "empresa_telefone", "Telefone do integrador", "Telefone da empresa", "-", "(31) 3333-0000", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.empresa_email", "empresa_email", "E-mail do integrador", "Email da empresa", "-", "contato@solartech.com", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.empresa_logo_url", "empresa_logo_url", "Logo da empresa", "URL do logotipo da empresa", "-", "https://...", "BT e MT", { notImplemented: true }),

  // ── Deal / Negócio ──
  v("comercial", "comercial.deal_title", "deal_title", "Título do Projeto", "Título do deal/negócio no pipeline", "-", "Projeto Solar Residencial", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.deal_status", "deal_status", "Status do Negócio", "Status do deal (open, won, lost)", "-", "open", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.deal_etiqueta", "deal_etiqueta", "Etiqueta do Projeto", "Etiqueta/tag do deal no pipeline", "-", "Urgente", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.deal_notas", "deal_notas", "Notas do Negócio", "Notas e observações do deal", "-", "Cliente com urgência", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.deal_expected_close_date", "deal_expected_close_date", "Previsão de Fechamento", "Data prevista de fechamento do negócio", "data", "30/04/2026", "BT e MT", { notImplemented: true }),

  // ── Proposta (complementares) ──
  v("comercial", "comercial.proposta_num", "proposta_num", "Número da Proposta", "Número sequencial da proposta", "-", "42", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.proposta_status", "proposta_status", "Status da Proposta", "Status atual da proposta (rascunho, enviada, aceita, etc.)", "-", "enviada", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.proposta_valido_ate", "proposta_valido_ate", "Proposta Válida Até", "Data limite de validade da proposta", "data", "30/04/2026", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.proposta_link_pdf", "proposta_link_pdf", "Link do PDF da Proposta", "URL para download do PDF da proposta", "-", "https://...", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.proposta_aceita_at", "proposta_aceita_at", "Data de Aceite da Proposta", "Data em que a proposta foi aceita pelo cliente", "data", "15/03/2026", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.proposta_enviada_at", "proposta_enviada_at", "Data de Envio da Proposta", "Data em que a proposta foi enviada ao cliente", "data", "10/03/2026", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.proposta_recusa_motivo", "proposta_recusa_motivo", "Motivo de Recusa", "Motivo pelo qual a proposta foi recusada", "-", "Preço elevado", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.proposta_recusada_at", "proposta_recusada_at", "Data de Recusa", "Data em que a proposta foi recusada", "data", "20/03/2026", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.proposta_regra_gd", "proposta_regra_gd", "Regra GD Aplicada", "Regra de geração distribuída aplicada no cálculo", "-", "Lei 14.300", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.proposta_origem_tarifa", "proposta_origem_tarifa", "Origem da Tarifa", "Fonte de dados da tarifa utilizada no cálculo", "-", "ANEEL", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.proposta_precisao_calculo", "proposta_precisao_calculo", "Precisão do Cálculo", "Nível de precisão do cálculo da proposta", "-", "alta", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.proposta_precisao_motivo", "proposta_precisao_motivo", "Motivo da Precisão", "Motivo da classificação de precisão do cálculo", "-", "Tarifa ANEEL atualizada", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.proposta_versao_atual", "proposta_versao_atual", "Versão Atual da Proposta", "Número da versão atual da proposta", "-", "3", "BT e MT", { notImplemented: true }),

  // ── Versão da Proposta (complementares) ──
  v("comercial", "comercial.proposta_inflacao_energetica", "proposta_inflacao_energetica", "Inflação Energética (%)", "Premissa de inflação energética usada na proposta", "%", "6.5", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.proposta_perda_eficiencia_anual", "proposta_perda_eficiencia_anual", "Perda de Eficiência Anual (%)", "Premissa de perda de eficiência anual do sistema", "%", "0.7", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.proposta_sobredimensionamento", "proposta_sobredimensionamento", "Sobredimensionamento (%)", "Percentual de sobredimensionamento aplicado", "%", "10", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.proposta_enviado_em", "proposta_enviado_em", "Versão Enviada Em", "Data de envio da versão da proposta", "data", "10/03/2026", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.proposta_aceito_em", "proposta_aceito_em", "Versão Aceita Em", "Data de aceite da versão da proposta", "data", "15/03/2026", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.proposta_rejeitado_em", "proposta_rejeitado_em", "Versão Rejeitada Em", "Data de rejeição da versão da proposta", "data", "20/03/2026", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.proposta_motivo_rejeicao", "proposta_motivo_rejeicao", "Motivo de Rejeição da Versão", "Motivo de rejeição da versão da proposta", "-", "Valores incorretos", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.proposta_output_docx_path", "proposta_output_docx_path", "Arquivo DOCX", "Caminho do arquivo DOCX gerado da proposta", "-", "propostas/v1.docx", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.proposta_output_pdf_path", "proposta_output_pdf_path", "Arquivo PDF", "Caminho do arquivo PDF gerado da proposta", "-", "propostas/v1.pdf", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.proposta_viewed_at", "proposta_viewed_at", "Visualizado Em", "Data em que a proposta foi visualizada pelo cliente", "data", "12/03/2026", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.proposta_observacoes", "proposta_observacoes", "Observações da Proposta", "Observações e notas da proposta", "-", "Desconto negociado", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.proposta_versao_status", "proposta_versao_status", "Status da Versão", "Status da versão da proposta (rascunho, enviada, aceita)", "-", "enviada", "BT e MT", { notImplemented: true }),
  ...
  v("comercial", "comercial.projeto_valor_equipamentos", "projeto_valor_equipamentos", "Valor Equipamentos", "Valor total dos equipamentos do projeto", "R$", "30000.00", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.projeto_valor_mao_obra", "projeto_valor_mao_obra", "Valor Mão de Obra", "Valor da mão de obra do projeto", "R$", "8000.00", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.projeto_data_venda", "projeto_data_venda", "Data da Venda", "Data de fechamento da venda", "data", "01/03/2026", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.projeto_data_previsao_instalacao", "projeto_data_previsao_instalacao", "Previsão de Instalação", "Data prevista para instalação do projeto", "data", "15/04/2026", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.projeto_data_instalacao", "projeto_data_instalacao", "Data de Instalação", "Data efetiva da instalação do projeto", "data", "20/04/2026", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.projeto_data_comissionamento", "projeto_data_comissionamento", "Data de Comissionamento", "Data de comissionamento do projeto", "data", "25/04/2026", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.projeto_status", "projeto_status", "Status do Projeto", "Status atual do projeto (em andamento, concluído, etc.)", "-", "em_andamento", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.projeto_forma_pagamento", "projeto_forma_pagamento", "Forma de Pagamento", "Forma de pagamento do projeto", "-", "Financiamento", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.projeto_valor_entrada", "projeto_valor_entrada", "Valor de Entrada", "Valor de entrada do projeto", "R$", "10000.00", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.projeto_valor_financiado", "projeto_valor_financiado", "Valor Financiado", "Valor financiado do projeto", "R$", "35000.00", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.projeto_numero_parcelas", "projeto_numero_parcelas", "Nº de Parcelas", "Número de parcelas do financiamento do projeto", "UN", "60", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.projeto_valor_parcela", "projeto_valor_parcela", "Valor da Parcela", "Valor mensal da parcela do projeto", "R$", "850.00", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.projeto_prazo_estimado_dias", "projeto_prazo_estimado_dias", "Prazo Estimado (dias)", "Prazo estimado em dias para conclusão do projeto", "dias", "30", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.projeto_prazo_vistoria_dias", "projeto_prazo_vistoria_dias", "Prazo Vistoria (dias)", "Prazo em dias para vistoria da concessionária", "dias", "15", "BT e MT", { notImplemented: true }),

  // ── Projeto (endereço de instalação) ──
  v("comercial", "comercial.projeto_rua_instalacao", "projeto_rua_instalacao", "Rua Instalação", "Rua do local de instalação", "-", "Rua Solar", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.projeto_numero_instalacao", "projeto_numero_instalacao", "Número Instalação", "Número do local de instalação", "-", "100", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.projeto_complemento_instalacao", "projeto_complemento_instalacao", "Complemento Instalação", "Complemento do endereço de instalação", "-", "Galpão 2", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.projeto_bairro_instalacao", "projeto_bairro_instalacao", "Bairro Instalação", "Bairro do local de instalação", "-", "Industrial", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.projeto_cidade_instalacao", "projeto_cidade_instalacao", "Cidade Instalação", "Cidade do local de instalação", "-", "Belo Horizonte", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.projeto_uf_instalacao", "projeto_uf_instalacao", "UF Instalação", "Estado/UF do local de instalação", "-", "MG", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.projeto_cep_instalacao", "projeto_cep_instalacao", "CEP Instalação", "CEP do local de instalação", "-", "30130-000", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.projeto_lat_instalacao", "projeto_lat_instalacao", "Latitude Instalação", "Latitude do local de instalação", "-", "-19.9167", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.projeto_lon_instalacao", "projeto_lon_instalacao", "Longitude Instalação", "Longitude do local de instalação", "-", "-43.9345", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.projeto_observacoes", "projeto_observacoes", "Observações do Projeto", "Observações e notas do projeto", "-", "Telhado com inclinação de 15°", "BT e MT", { notImplemented: true }),
  ...
  v("comercial", "comercial.consultor_codigo", "consultor_codigo", "Código do Consultor", "Código identificador do consultor", "-", "CONS-001", "BT e MT", { notImplemented: true }),

  // ── Concessionária (detalhes) ──
  v("comercial", "comercial.concessionaria_sigla", "concessionaria_sigla", "Sigla da Concessionária", "Sigla/abreviação da concessionária", "-", "CEMIG", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.concessionaria_estado", "concessionaria_estado", "Estado da Concessionária", "Estado de atuação da concessionária", "-", "MG", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.concessionaria_tarifa_fio_b", "concessionaria_tarifa_fio_b", "Tarifa Fio B da Concessionária", "Valor da tarifa Fio B da concessionária", "R$/kWh", "0.21", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.concessionaria_custo_disponibilidade_monofasico", "concessionaria_custo_disponibilidade_monofasico", "Custo Disp. Monofásico", "Custo de disponibilidade monofásico da concessionária", "kWh", "30", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.concessionaria_custo_disponibilidade_bifasico", "concessionaria_custo_disponibilidade_bifasico", "Custo Disp. Bifásico", "Custo de disponibilidade bifásico da concessionária", "kWh", "50", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.concessionaria_custo_disponibilidade_trifasico", "concessionaria_custo_disponibilidade_trifasico", "Custo Disp. Trifásico", "Custo de disponibilidade trifásico da concessionária", "kWh", "100", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.concessionaria_aliquota_icms", "concessionaria_aliquota_icms", "Alíquota ICMS", "Alíquota de ICMS da concessionária", "%", "18", "BT e MT", { notImplemented: true }),
  ...
  v("comercial", "comercial.concessionaria_possui_isencao_scee", "concessionaria_possui_isencao_scee", "Possui Isenção SCEE", "Se a concessionária possui isenção SCEE", "-", "Sim", "BT e MT", { notImplemented: true }),
  ...
  v("comercial", "comercial.simulacao_tipo_conta", "simulacao_tipo_conta", "Tipo de Conta", "Tipo de conta de energia da simulação", "-", "Residencial", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.simulacao_co2_evitado_kg", "simulacao_co2_evitado_kg", "CO₂ Evitado (kg)", "Quantidade de CO₂ evitada pela geração solar", "kg", "5400", "BT e MT", { notImplemented: true }),

  // ── Cliente (complementares) ──
  v("comercial", "comercial.cliente_observacoes", "cliente_observacoes", "Observações do Cliente", "Observações e notas sobre o cliente", "-", "Cliente preferencial", "BT e MT", { notImplemented: true }),

  // ── Representante Legal da Empresa ──
  v("comercial", "comercial.empresa_representante_legal", "empresa_representante_legal", "Representante Legal", "Nome do representante legal da empresa", "-", "Carlos Alberto Silva", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.empresa_representante_cpf", "empresa_representante_cpf", "CPF do Representante", "CPF do representante legal da empresa", "-", "123.456.789-00", "BT e MT", { notImplemented: true }),
  v("comercial", "comercial.empresa_representante_cargo", "empresa_representante_cargo", "Cargo do Representante", "Cargo do representante legal (ex: Sócio-Diretor)", "-", "Sócio-Diretor", "BT e MT", { notImplemented: true }),
  ...
  // ──────────────────────────────────────────────────────────────
  v("cdd", "cdd.tipo_estrutura", "cdd_tipo_estrutura", "Tipo de estrutura", "Tipo de Telhado / Tipo de Estrutura — ECORI, GENYX, WEG SOLAR, NEOSOLAR, BLUESUN, SOLARMARKET", "", "Solo", "BT e MT", "BT e MT", { notImplemented: true }),
  v("cdd", "cdd.marca_estrutura", "cdd_marca_estrutura", "Solução Estrutural", "Solução Estrutural / Marca da estrutura — ECORI", "", "Romagnole", "BT e MT", "BT e MT", { notImplemented: true }),
  v("cdd", "cdd.comunicador", "cdd_comunicador", "Utiliza Comunicador?", "Tipo de comunicador de dados — ECORI", "", "Wi-Fi", "BT e MT", "BT e MT", { notImplemented: true }),
  v("cdd", "cdd.tipo_sustentacao", "cdd_tipo_sustentacao", "Tipo de Sustentação", "Tipo de sustentação — GENYX", "", "Laje", "BT e MT", "BT e MT", { notImplemented: true }),
  v("cdd", "cdd.tipo_telhado", "cdd_tipo_telhado", "Tipo de telhado utilizado", "Tipo de telhado utilizado / Onde será instalado — NEXEN, GTSOLAR", "", "Cerâmico", "BT e MT", "BT e MT", { notImplemented: true }),
  v("cdd", "cdd.nivel", "cdd_nivel", "Nível da estrutura", "Nível do distribuidor — BLUESUN, SOLARMARKET", "", "Gold", "BT e MT", "BT e MT", { notImplemented: true }),
  v("cdd", "cdd.orientacao", "cdd_orientacao", "Orientação", "Orientação dos módulos — BLUESUN, SOLARMARKET", "", "Norte", "BT e MT", "BT e MT", { notImplemented: true }),
  v("cdd", "cdd.string_config", "cdd_string", "Adicionar StringBox CC?", "StringBox CC / Deseja Incluir StringBox — BLUESUN, SOLARMARKET", "", "2x8", "BT e MT", "BT e MT", { notImplemented: true }),
  v("cdd", "cdd.string_ca", "cdd_sting_ca", "Adicionar StringBox CA?", "Configuração de strings CA — BLUESUN, SOLARMARKET", "", "1x1", "BT e MT", "BT e MT", { notImplemented: true }),
  v("cdd", "cdd.telhado", "cdd_telhado", "Tipo de Telhado", "Tipo de telhado no cadastro — SOLARMARKET", "", "Cerâmico", "BT e MT", "BT e MT", { notImplemented: true }),
  v("cdd", "cdd.estrutura", "cdd_estrutura", "Estrutura", "Estrutura / Estrutura do Telhado — A.DIAS SOLAR, SOPRANO, SOLARMARKET, BLUESUN, FORTLEV, ALDO", "", "Fibrocimento", "BT e MT", "BT e MT", { notImplemented: true }),
  v("cdd", "cdd.tipo_perfil", "cdd_tipo_perfil", "Tipo de Perfil", "Tipo de perfil da estrutura — WEG SOLAR", "", "Perfil", "BT e MT", "BT e MT", { notImplemented: true }),
