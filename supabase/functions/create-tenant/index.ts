...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const defaultCharts = [
      { name: "Consumo Mensal", placeholder: "grafico_consumo_mensal", chart_type: "bar", engine: "rendered_image", data_source: "tabelas.consumo_mensal", label_field: "mes", value_field: "valor", title: "Consumo de Energia", subtitle: "kWh por mês", colors: ["#ef4444"], chart_options: {}, width: 1600, height: 900, show_legend: false, show_grid: true, show_labels: true, active: true },
      ...
      { name: "Economia Mensal", placeholder: "grafico_economia_mensal", chart_type: "bar", engine: "rendered_image", data_source: "tabelas.economia_mensal", label_field: "mes", value_field: "valor", title: "Economia Mensal Estimada", subtitle: "Economia em R$", colors: ["#10b981"], chart_options: {}, width: 1600, height: 900, show_legend: false, show_grid: true, show_labels: true, active: true },
      { name: "Comparação de Custos", placeholder: "vc_grafico_de_comparacao", chart_type: "bar", engine: "rendered_image", data_source: "tabelas.comparacao_investimento", label_field: "item", value_field: "valor", title: "Comparação de Custos", subtitle: "Antes e Depois da Energia Solar", colors: ["#ef4444","#3b82f6","#f59e0b","#8b5cf6","#06b6d4"], chart_options: {}, width: 1600, height: 900, show_legend: true, show_grid: true, show_labels: true, active: true },
      { name: "Fluxo de Caixa Acumulado", placeholder: "s_fluxo_caixa_acumulado_anual", chart_type: "bar", engine: "rendered_image", data_source: "tabelas.fluxo_caixa", label_field: "ano", value_field: "valor", title: "Retorno do Investimento", subtitle: "Fluxo de caixa acumulado", colors: ["#f59e0b","#3b82f6"], chart_options: { negativeColor: "#f59e0b", positiveColor: "#3b82f6" }, width: 1600, height: 900, show_legend: true, show_grid: true, show_labels: true, active: true },
    ];
