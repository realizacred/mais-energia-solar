...
export function calcularSerieFinanceira25Anos(input: FinancialSeriesInput): FinancialSeriesOutput {
  ...
  // UX-01: Inflação energética centralizada em 9.5%
  ...
  // UX-01: Taxa de desconto centralizada em 10%
  ...
  // Payback centralizado com bisection (mais preciso)
