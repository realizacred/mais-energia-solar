-- Schedule monthly charge generation: day 1 at 11:00 UTC (8:00 BRT)
SELECT cron.schedule(
  'generate-uc-monthly-charges',
  '0 11 1 * *',
  $$
  SELECT net.http_post(
    url := 'https://bguhckqkpnziykpbwbeu.supabase.co/functions/v1/generate-monthly-charges',
