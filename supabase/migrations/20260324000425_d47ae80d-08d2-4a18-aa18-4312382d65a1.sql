-- Schedule hourly cron job for proactive energy alert scanning
SELECT cron.schedule(
  'check-energy-alerts-hourly',
  '0 * * * *',
  $$SELECT net.http_post(
    url := 'https://bguhckqkpnziykpbwbeu.supabase.co/functions/v1/check-energy-alerts',
