...
-- Fix RPC: use 'rascunho' (matches CHECK constraint on propostas_nativas.status)
...
BEGIN
  ...
  -- status = 'rascunho' (matches CHECK constraint chk_status)
  ...
  VALUES (v_tenant_id, v_proposta_id, 1, 'rascunho', p_potencia_kwp, p_valor_total, p_snapshot)
