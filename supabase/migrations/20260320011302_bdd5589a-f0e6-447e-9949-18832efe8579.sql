-- Create cron job for check-billing-emails (hourly)
SELECT cron.schedule(
  'check-billing-emails-hourly',
  '0 */1 * * *',
  $$
  SELECT net.http_post(
    url := 'https://bguhckqkpnziykpbwbeu.supabase.co/functions/v1/check-billing-emails',
