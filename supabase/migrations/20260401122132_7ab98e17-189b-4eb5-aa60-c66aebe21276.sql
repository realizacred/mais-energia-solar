-- Update proposal_delete: when no active proposals remain, remove deal from
-- non-commercial pipelines (e.g. Engenharia) but keep commercial pipeline membership.
...
BEGIN
  ...
  -- If no more active proposals remain in the project
  IF v_deal_id IS NOT NULL THEN
    IF NOT EXISTS (
      ...
      -- Delete installation checklists (existing behavior)
      ...
      -- Remove from non-commercial pipelines (e.g. Engenharia)
      -- Commercial pipeline is controlled manually by the seller
