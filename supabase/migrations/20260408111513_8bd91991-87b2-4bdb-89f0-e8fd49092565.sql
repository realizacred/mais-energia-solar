...
BEGIN
  ...
  INSERT INTO proposta_versao_ucs (versao_id, tenant_id, uc_numero, consumo_kwh, demanda_contratada, is_geradora)
  SELECT v_new_versao_id, v_tenant_id, uc_numero, consumo_kwh, demanda_contratada, is_geradora
