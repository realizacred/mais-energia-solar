...
BEGIN
  ...
  -- If no projeto_id, create one — let trigger generate codigo automatically (PROJ-XXXX)
  IF v_projeto_id IS NULL THEN
    INSERT INTO projetos (tenant_id, lead_id, cliente_id, status)
    VALUES (v_tenant_id, p_lead_id, v_cliente_id, 'criado')
