-- ═══════════════════════════════════════════════════════
-- 1. RPC proposal_create — atomic creation of proposta + first version
-- ═══════════════════════════════════════════════════════
...
BEGIN
  ...
  -- 2. Resolve projeto_id (required NOT NULL column)
  v_resolved_projeto_id := p_projeto_id;

  -- If no projeto_id but deal_id provided, lookup the linked project
  ...
  -- 3. Create propostas_nativas (triggers handle proposta_num, codigo, titulo)
  INSERT INTO propostas_nativas (
    ...
    'rascunho'::proposta_nativa_status,
    v_user_id,
    1
  )
...
-- ═══════════════════════════════════════════════════════
-- 2. RPC proposal_clone — atomic clone of proposta + version + UCs
-- ═══════════════════════════════════════════════════════
...
BEGIN
  ...
  -- Resolve projeto_id from target deal
