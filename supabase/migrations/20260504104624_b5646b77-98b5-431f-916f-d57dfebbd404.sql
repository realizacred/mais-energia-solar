SELECT cron.unschedule('equipment-enrichment-worker-tick');

SELECT cron.schedule(
  'equipment-enrichment-worker-tick',
  '*/2 * * * *',
  $$
  SELECT net.http_post(
    url := 'https://bguhckqkpnziykpbwbeu.supabase.co/functions/v1/equipment-enrichment-worker',
